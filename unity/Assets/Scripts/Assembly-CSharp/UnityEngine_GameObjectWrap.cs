...
public class UnityEngine_GameObjectWrap
{
	...
	private static int Z(IntPtr L)
	{
		return 0;
	}

	private static int Y(IntPtr L)
	{
		return 0;
	}

	private static int X(IntPtr L)
	{
		return 0;
	}
	...
	private static int ComponentsByName(IntPtr L)
	{
		return 0;
	}

	private static int ComponentByName(IntPtr L)
	{
		return 0;
	}

	private static int NodeByName(IntPtr L)
	{
		return 0;
	}
