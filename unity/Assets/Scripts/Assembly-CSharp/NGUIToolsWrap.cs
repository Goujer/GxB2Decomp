...
public class NGUIToolsWrap
{
	...
	private static int copyToClipboard(IntPtr L)
	{
		return 0;
	}
	...
	private static int SetPanelConstrainButDontClip(IntPtr L)
	{
		return 0;
	}
	...
	private static int SetUICameraOnClickDelegate(IntPtr L)
	{
		return 0;
	}
	...
	private static int SetPanelsLayer(IntPtr L)
	{
		return 0;
	}
	...
	private static int CaptionToKey(IntPtr L)
	{
		return 0;
	}
	...
	private static int LinearToGammaSpace(IntPtr L)
	{
		return 0;
	}
