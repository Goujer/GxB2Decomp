...
public abstract class UIRect : MonoBehaviour
{
	...
	[NonSerialized]
	protected bool isArabicInitDone;
	...
	public virtual void StartArabicInit()
	{
	}
	...
	public void SetLeftAnchor(GameObject go, float left, int leftOffset)
	{
	}

	public void SetRightAnchor(GameObject go, float right, int rightOffset)
	{
	}

	public void SetTopAnchor(GameObject go, float top, int topOffset)
	{
	}

	public void SetBottomAnchor(GameObject go, float bottom, int bottomOffset)
	{
	}

	public void SetLeftAnchor(Transform t, float left, int leftOffset)
	{
	}

	public void SetRightAnchor(Transform t, float right, int rightOffset)
	{
	}

	public void SetTopAnchor(Transform t, float top, int topOffset)
	{
	}

	public void SetBottomAnchor(Transform t, float bottom, int bottomOffset)
	{
	}
