...
public class UIWidgetWrap
{
	...
	private static int SetColorNoAlpha(IntPtr L)
	{
		return 0;
	}
	...
	private static int get_isflipVert(IntPtr L)
	{
		return 0;
	}

	private static int get_mStencilClip(IntPtr L)
	{
		return 0;
	}

	private static int get_mStencilClear(IntPtr L)
	{
		return 0;
	}
	...
	private static int get_onDispose(IntPtr L)
	{
		return 0;
	}
	...
	private static int get_Has_Invalidated(IntPtr L)
	{
		return 0;
	}
	...
	private static int get_invalidated(IntPtr L)
	{
		return 0;
	}
	...
	private static int set_isflipVert(IntPtr L)
	{
		return 0;
	}

	private static int set_mStencilClip(IntPtr L)
	{
		return 0;
	}

	private static int set_mStencilClear(IntPtr L)
	{
		return 0;
	}
	...
	private static int set_onDispose(IntPtr L)
	{
		return 0;
	}
	...
	private static int set_Has_Invalidated(IntPtr L)
	{
		return 0;
	}
	...
	private static int set_invalidated(IntPtr L)
	{
		return 0;
	}
	...
	private static int UIWidget_OnDisPoseFunc(IntPtr L)
	{
		return 0;
	}
