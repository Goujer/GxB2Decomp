...
public class UIEventListenerWrap
{
	...
	private static int removeEvent(IntPtr L)
	{
		return 0;
	}
	...
	private static int get_guideClick(IntPtr L)
	{
		return 0;
	}
	...
	private static int get_needsActiveCollider(IntPtr L)
	{
		return 0;
	}
	...
	private static int set_guideClick(IntPtr L)
	{
		return 0;
	}
	...
	private static int set_needsActiveCollider(IntPtr L)
	{
		return 0;
	}
