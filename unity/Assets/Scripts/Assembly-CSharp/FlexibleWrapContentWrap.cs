...
public class FlexibleWrapContentWrap
{
	...
	private static int FlexibleWrapContent_OnScroll(IntPtr L)
	{
		return 0;
	}

	private static int FlexibleWrapContent_OnInitializeItem(IntPtr L)
	{
		return 0;
	}
}
