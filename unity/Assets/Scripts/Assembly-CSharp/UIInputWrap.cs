...
public class UIInputWrap
{
	...
	private static int SetForce(IntPtr L)
	{
		return 0;
	}
	...
	private static int OnApplicationFocus(IntPtr L)
	{
		return 0;
	}

	private static int OnApplicationPause(IntPtr L)
	{
		return 0;
	}

	private static int SelectAll(IntPtr L)
	{
		return 0;
	}
	...
	private static int GetSelections(IntPtr L)
	{
		return 0;
	}
	...
	private static int get_isSupportArabic(IntPtr L)
	{
		return 0;
	}
	...
	private static int get_submitOnUnselect(IntPtr L)
	{
		return 0;
	}
	...
	private static int get_onUpArrow(IntPtr L)
	{
		return 0;
	}

	private static int get_onDownArrow(IntPtr L)
	{
		return 0;
	}
	...
	private static int get_isOnDragLight(IntPtr L)
	{
		return 0;
	}
	...
	private static int get_caretVerts(IntPtr L)
	{
		return 0;
	}
	...
	private static int set_isSupportArabic(IntPtr L)
	{
		return 0;
	}
	...
	private static int set_submitOnUnselect(IntPtr L)
	{
		return 0;
	}
	...
	private static int set_onUpArrow(IntPtr L)
	{
		return 0;
	}

	private static int set_onDownArrow(IntPtr L)
	{
		return 0;
	}
	...
	private static int set_isOnDragLight(IntPtr L)
	{
		return 0;
	}
