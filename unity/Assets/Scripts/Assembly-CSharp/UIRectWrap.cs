...
public class UIRectWrap
{
	...
	private static int SetLeftAnchor(IntPtr L)
	{
		return 0;
	}

	private static int SetRightAnchor(IntPtr L)
	{
		return 0;
	}

	private static int SetTopAnchor(IntPtr L)
	{
		return 0;
	}

	private static int SetBottomAnchor(IntPtr L)
	{
		return 0;
	}
	...
	private static int get_isArabicFlip(IntPtr L)
	{
		return 0;
	}
	...
	private static int set_isArabicFlip(IntPtr L)
	{
		return 0;
	}
