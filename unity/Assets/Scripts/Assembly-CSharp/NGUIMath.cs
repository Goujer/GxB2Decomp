...
public static class NGUIMath
{
	...
	public static Rect ConvertToTexCoords(Rect rect, int width, int height, bool isOffset)
	{
		return default(Rect);
	}

	public static Rect ConvertToTexCoords(Rect rect, int width, int height, float xMinOff, float xMaxOff, float yMinOff, float yMaxOff)
	{
		return default(Rect);
	}
