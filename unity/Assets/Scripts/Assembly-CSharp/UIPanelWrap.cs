...
public class UIPanelWrap
{
	...
	private static int AddUIParticle(IntPtr L)
	{
		return 0;
	}

	private static int RemoveUIParticle(IntPtr L)
	{
		return 0;
	}

	private static int UpdateUIParticles(IntPtr L)
	{
		return 0;
	}

	private static int AddSpineAnim(IntPtr L)
	{
		return 0;
	}

	private static int RemoveSpineAnim(IntPtr L)
	{
		return 0;
	}

	private static int UpdateSpine(IntPtr L)
	{
		return 0;
	}

	private static int AddUIDragonBones(IntPtr L)
	{
		return 0;
	}

	private static int RemoveUIDragonBones(IntPtr L)
	{
		return 0;
	}

	private static int UpdateUIDragonBones(IntPtr L)
	{
		return 0;
	}
	...
	private static int CalculateConstrainOffset2(IntPtr L)
	{
		return 0;
	}
	...
	private static int get_generateUV2(IntPtr L)
	{
		return 0;
	}

	private static int get_shadowMode(IntPtr L)
	{
		return 0;
	}
	...
	private static int get_onCreateMaterial(IntPtr L)
	{
		return 0;
	}

	private static int get_onCreateDrawCall(IntPtr L)
	{
		return 0;
	}

	private static int get_useSortingOrder(IntPtr L)
	{
		return 0;
	}
	...
	private static int set_generateUV2(IntPtr L)
	{
		return 0;
	}

	private static int set_shadowMode(IntPtr L)
	{
		return 0;
	}
	...
	private static int set_onCreateMaterial(IntPtr L)
	{
		return 0;
	}

	private static int set_onCreateDrawCall(IntPtr L)
	{
		return 0;
	}

	private static int set_useSortingOrder(IntPtr L)
	{
		return 0;
	}
	...
	private static int UIPanel_OnCreateMaterial(IntPtr L)
	{
		return 0;
	}
