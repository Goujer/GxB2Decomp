...
public class UIScrollViewWrap
{
	...
	private static int StopMove(IntPtr L)
	{
		return 0;
	}
	...
	private static int get_isLateUpdateMoveTween(IntPtr L)
	{
		return 0;
	}
	...
	private static int get_onDragMoving(IntPtr L)
	{
		return 0;
	}

	private static int get_stopInTop(IntPtr L)
	{
		return 0;
	}

	private static int get_stopInBot(IntPtr L)
	{
		return 0;
	}
	...
	private static int set_isLateUpdateMoveTween(IntPtr L)
	{
		return 0;
	}
	...
	private static int set_onDragMoving(IntPtr L)
	{
		return 0;
	}

	private static int set_stopInTop(IntPtr L)
	{
		return 0;
	}

	private static int set_stopInBot(IntPtr L)
	{
		return 0;
	}
