...
public class UILabelWrap
{
	...
	private static int StartArabicInit(IntPtr L)
	{
		return 0;
	}

	private static int FixShadowStyle(IntPtr L)
	{
		return 0;
	}
	...
	private static int ApplyGrey(IntPtr L)
	{
		return 0;
	}

	private static int ApplyOrigin(IntPtr L)
	{
		return 0;
	}
	...
	private static int get_AutoFixArabic(IntPtr L)
	{
		return 0;
	}

	private static int get_considerEast(IntPtr L)
	{
		return 0;
	}

	private static int get_no_breaking_space(IntPtr L)
	{
		return 0;
	}
	...
	private static int get_baseLevel(IntPtr L)
	{
		return 0;
	}
	...
	private static int get_useEmojis(IntPtr L)
	{
		return 0;
	}

	private static int get_hasEmojis(IntPtr L)
	{
		return 0;
	}

	private static int get_emojiProvider(IntPtr L)
	{
		return 0;
	}

	private static int get_emojiTexture(IntPtr L)
	{
		return 0;
	}
	...
	private static int get_overflowHeight(IntPtr L)
	{
		return 0;
	}
	...
	private static int get_quadsPerCharacter(IntPtr L)
	{
		return 0;
	}
	...
	private static int set_AutoFixArabic(IntPtr L)
	{
		return 0;
	}

	private static int set_considerEast(IntPtr L)
	{
		return 0;
	}
	...
	private static int set_useEmojis(IntPtr L)
	{
		return 0;
	}

	private static int set_emojiProvider(IntPtr L)
	{
		return 0;
	}
	...
	private static int set_overflowHeight(IntPtr L)
	{
		return 0;
	}
