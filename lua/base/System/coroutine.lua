-- chunkname: @../../../Product/Bundles/Android/src/base/System/coroutine.lua
...
function coroutine.wait(t, co, ...)
	...
	local timer
	local coroutine_trace = debug.traceback(co, "coroutine.step traceback:", 1)

	local function action()
		comap[co] = nil
		timer.func = nil
		xyd.coroutine_resume_trace = coroutine_trace

		local flag, msg = resume(co, unpack(args))

		xyd.coroutine_resume_trace = ""
