-- chunkname: @../../../Product/Bundles/Android/src/app/windows/ItemBuyWindow.lua
...
function ItemBuyWindow:initUIComponent()
	...
	local params = {
		...
		callback = function(input)
			...
			if maxCanBuy and maxCanBuy > 0 and maxCanBuy <= self.purchaseNum_ and input >= self.purchaseNum_ then
...
function ItemBuyWindow:updateLayout()
	...
	if total < costNow then
		self.labelTotalVal_.color = Color.New2(3422556671)
	else
