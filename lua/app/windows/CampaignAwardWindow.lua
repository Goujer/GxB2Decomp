-- chunkname: @../../../Product/Bundles/Android/src/app/windows/CampaignAwardWindow.lua
...
function AwardItem:update(_, _, params)
	...
	if self.isAwarded_ and self.isAwarded_ == 1 then
		...
		xyd.setUISpriteAsync(self.awardImg_, nil, "mission_awarded_" .. tostring(xyd.Global.lang) .. "_png", nil, nil, true)
...
function CampaignAwardWindow:awardAll()
	...
	for idx, id in ipairs(ids) do
		if tonumber(id) >= achievementData.achieve_id then
