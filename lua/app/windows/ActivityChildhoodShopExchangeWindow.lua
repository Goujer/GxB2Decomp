-- chunkname: @../../../Product/Bundles/Android/src/app/windows/ActivityChildhoodShopExchangeWindow.lua
...
function ActivityChildhoodShopExchangeWindowItem:setInfo(params)
	...
	if self.buyTime >= self.limitTime then
	...
	if self.buyTime >= self.limitTime or self.isLock then
