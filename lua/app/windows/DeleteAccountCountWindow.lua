-- chunkname: @../../../Product/Bundles/Android/src/app/windows/DeleteAccountCountWindow.lua
...
function DeleteAccountCountWindow:layout()
	...
	if self.server_time_ >= self.endTime_ then
...
function DeleteAccountCountWindow:onClickBack()
	...
	url = XYDUtils.IsTest() and "https://testyotmhome.game168.com.tw" or "https://carolgames.com"
