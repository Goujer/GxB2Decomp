-- chunkname: @../../../Product/Bundles/Android/src/app/windows/GuildJoinWindow.lua
...
function GuildSearch:initUIComponent()
	...
	self.textInput.gameObject:GetComponent(typeof(UIInput)).defaultColor = Color.New2(3385711103)
...
function GuildCreate:initUIComponent()
	...
	self.editableText.gameObject:GetComponent(typeof(UIInput)).defaultColor = Color.New2(3385711103)
