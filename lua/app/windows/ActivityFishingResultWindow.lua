-- chunkname: @../../../Product/Bundles/Android/src/app/windows/ActivityFishingResultWindow.lua
...
function ActivityFishingResultWindow:initUIComponent()
	...
	xyd.setUISpriteAsync(self.imgFish, nil, xyd.tables.activityFishingMainTable:getPic(self.id), nil, nil, true)
	...
	if self.len >= goldLenRange[2][1] then
		xyd.setUISpriteAsync(self.imgCrown, nil, "activity_fishing_icon_gold")
	elseif self.len >= silverLenRange[2][1] then
