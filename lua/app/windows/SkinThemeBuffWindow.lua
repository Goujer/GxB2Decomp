-- chunkname: @../../../Product/Bundles/Android/src/app/windows/SkinThemeBuffWindow.lua
...
function TaskItem:setInfo(params)
	...
	self.haveFinish = self.skinHasNum >= self.num
	...
	if self.haveFinish then
		...
		self.labelDesc.color = Color.New2(2155905279)
		self.labelHasNum.color = Color.New2(2155905279)
	end
end
