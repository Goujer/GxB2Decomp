-- chunkname: @../../../Product/Bundles/Android/src/app/windows/ActivityChimeGiftbagWindow.lua
...
function ActivityChimeGiftbagWindow:layout()
	...
	xyd.setUISpriteAsync(self.logoTextImg, nil, "activity_chime_text_bg_xyys_" .. xyd.Global.lang, nil, nil, true)
...
function ActivityChimeGiftbagWindow:setUpIcon(dayInfo)
	...
	if countTime > self.activityData:getEndTime() then
