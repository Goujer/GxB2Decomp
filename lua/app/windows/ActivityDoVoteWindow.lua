-- chunkname: @../../../Product/Bundles/Android/src/app/windows/ActivityDoVoteWindow.lua
...
function ActivityDoVoteWindow:initUI()
	...
	xyd.setUISpriteAsync(self.titleImg_, nil, "activity_vote_vote_title_" .. xyd.Global.lang, nil, nil, true)
...
function ActivityDoVoteWindow:initPartnerCard()
	local table_ids, cur_center_ = self.table_:getShowIDs(self.id_), 1
