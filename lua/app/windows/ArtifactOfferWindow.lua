-- chunkname: @../../../Product/Bundles/Android/src/app/windows/ArtifactOfferWindow.lua
	...
	if group > 0 or job > 0 then
		...
		for _, act in ipairs(acts) do
			...
			if self.data.equipedPartner then
				...
				if isFit then
					label1.textColor = 2986409983
					label.textColor = 3613720831
				end
			end
