-- chunkname: @../../../Product/Bundles/Android/src/app/windows/sanxiao_window/QuestWindow.lua
...
function QuestWindow:initGift()
	...
	for key in pairs(rewards) do
		...
		if numKey > self._questModel.progress then
			if numKey ~= 100 then
...
function QuestWindow:_onBtnQuest()
	...
	self.txt_quest.color = Color.New2(4294307839)
...
function QuestWindow:_onBtnZone()
	...
	self.txt_zone.color = Color.New2(4294307839)
...
function QuestWindow:_onBtnVisit()
	...
	self.txt_visit.color = Color.New2(4294307839)
