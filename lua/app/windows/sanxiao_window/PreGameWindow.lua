-- chunkname: @../../../Product/Bundles/Android/src/app/windows/sanxiao_window/PreGameWindow.lua
...
function PreGameWindow:initDiff()
	...
	elseif self._diff == 1 then
		...
		self.selectItemText_.effectColor = Color.New2(3123123967)
		self.stage_txt1_.effectColor = Color.New2(3123123967)
		self.stage_txt2_.effectColor = Color.New2(3123123967)
	...
	elseif self._diff == 3 then
		...
		self.selectItemText_.effectColor = Color.New2(2553208063)
		self.stage_txt1_.effectColor = Color.New2(2553208063)
		self.stage_txt2_.effectColor = Color.New2(2553208063)
	end
end
