-- chunkname: @../../../Product/Bundles/Android/src/app/windows/ActivityFairyTaleGiftPreviewWindow.lua
...
function ActivityFairyTaleGiftPreviewWindow:refreshList()
	...
	for i = 2, #ids do
		...
		params.id = ids[i]
		params.awards = xyd.tables.activityFairyTaleLevelTable:getAwards(ids[i])
