-- chunkname: @../../../Product/Bundles/Android/src/app/windows/EnhanceWindow.lua
...
function EnhanceItem:SetInfo(params)
	...
	xyd.setUISpriteAsync(self.titleIcon_, nil, xyd.tables.enhanceTable:getIcon(self.id_), nil, nil)
	self:createContent()
	self:setTouchEvent()
end
