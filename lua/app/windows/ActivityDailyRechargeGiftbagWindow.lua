-- chunkname: @../../../Product/Bundles/Android/src/app/windows/ActivityDailyRechargeGiftbagWindow.lua
...
function ActivityDailyRechargeGiftbagWindow:initUIComponent()
	...
	if self.buy_times < self.limit_times then
		...
		for i = 1, #self.activityData.detail.charges - 1 do
			if self.activityData.detail.charges[i].buy_times >= self.activityData.detail.charges[i].limit_times then
