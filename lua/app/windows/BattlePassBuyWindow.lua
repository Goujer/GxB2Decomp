-- chunkname: @../../../Product/Bundles/Android/src/app/windows/BattlePassBuyWindow.lua
...
function BattlePassBuyWindow:layout()
	...
	xyd.setUISpriteAsync(self.titleImgTop_, nil, "bp_buy_logo_" .. xyd.Global.lang, nil, nil, true)
	xyd.setUISpriteAsync(self.titleImgBottom_, nil, "bp_buy_logo2_" .. xyd.Global.lang, nil, nil, true)
...
function BattlePassBuyWindow:checkLastTime()
	...
	if endTime - xyd.getServerTime() > xyd.DAY and endTime - xyd.getServerTime() <= xyd.DAY * lastTimeList[1] then
