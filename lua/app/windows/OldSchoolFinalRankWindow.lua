-- chunkname: @../../../Product/Bundles/Android/src/app/windows/OldSchoolFinalRankWindow.lua

local OldSchoolFinalRankWindow = class("OldSchoolFinalRankWindow", import(".BaseWindow"))
...
function OldSchoolFinalRankWindow:ctor(name, params)
	OldSchoolFinalRankWindow.super.ctor(self, name, params)
end

function OldSchoolFinalRankWindow:initRankInfo(event)
...
function OldSchoolFinalRankWindow:initWindow()
	self:getComponent()
	OldSchoolFinalRankWindow.super.initWindow(self)
	self:registerEvent()
	self:initTopGroup()
	self:initCommonUI()
...
function OldSchoolFinalRankWindow:updateScoreGetAwardRedPoint()
	return
end

function OldSchoolFinalRankWindow:initCommonUI()
	xyd.setUISpriteAsync(self.titleImg, nil, "old_school_title_" .. xyd.Global.lang, nil, nil)
	self:initTime()
end

function OldSchoolFinalRankWindow:initTime()
	self.tipsText.text = __("OLD_SCHOOL_TIME_TEXT2")
...
function OldSchoolFinalRankWindow:timeOver()
...
function OldSchoolFinalRankWindow:initTopGroup()
...
function OldSchoolFinalRankWindow:registerEvent()
...
function OldSchoolFinalRankWindow:getComponent()
	...
	self.titleImg = groupAction:ComponentByName("titleImg", typeof(UISprite))
	self.tipsTextCon = groupAction:NodeByName("tipsTextCon").gameObject
	self.tipsTextCon_layout = groupAction:ComponentByName("tipsTextCon", typeof(UILayout))
	...
	self.group1 = groupAction:NodeByName("group1").gameObject
...
function OldSchoolFinalRankWindow:initUI()
...
function OldSchoolFinalRankWindow:initUpCon()
...
function OldSchoolFinalRankWindow:setCountDown()
...
function OldSchoolFinalRankWindow:initNav()
	local index = 2
	local labelStates = {
		chosen = {
...
function OldSchoolFinalRankWindow:updateLayout(index)
...
function OldSchoolFinalRankWindow:initRankList()
	self.rankListInfo_ = {}
...
function OldSchoolFinalRankWindow:initAward()
...
function OldSchoolFinalRankWindow:initKillAward()
...
function OldSchoolFinalRankWindow:initBattleAward()
...
return OldSchoolFinalRankWindow
