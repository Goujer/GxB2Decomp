-- chunkname: @../../../Product/Bundles/Android/src/app/windows/ShrineHurdleNoticeWindow.lua
...
function AchievementItem:layout()
	xyd.setUISpriteAsync(self.imgAward_, nil, "mission_awarded_" .. tostring(xyd.Global.lang) .. "_png", nil, nil)
end
...
function ShrineHurdleNoticeWindow:updatePageByTag(event)
	...
	elseif params.tag == xyd.ShrineNoticeTag.MISSION then
		...
		self:initMissions()
	elseif params.tag == xyd.ShrineNoticeTag.RANK then
