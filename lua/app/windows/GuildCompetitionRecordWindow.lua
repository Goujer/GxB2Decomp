-- chunkname: @../../../Product/Bundles/Android/src/app/windows/GuildCompetitionRecordWindow.lua
		...
		if tonumber(a.attend_times) == tonumber(b.attend_times) then
			if tonumber(a.data.job) == tonumber(b.data.job) then
				if tonumber(a.data.is_online) == tonumber(b.data.is_online) then
					result = tonumber(a.data.last_time) > tonumber(b.data.last_time)
				else
					result = tonumber(a.data.is_online) > tonumber(b.data.is_online)
				end
			else
				result = tonumber(a.data.job) > tonumber(b.data.job)
			end
		else
