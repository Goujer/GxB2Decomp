-- chunkname: @../../../Product/Bundles/Android/src/app/windows/CollectionWindow.lua
...
function CollectionWindow:returnCommonScreen()
	...
	do
		local ____TS_obj, ____TS_index = self.logo, "y"

		____TS_obj[____TS_index] = ____TS_obj[____TS_index] - 50 * self.scale_num_
	end

	local ____TS_obj, ____TS_index = self.heroBg, "y"
