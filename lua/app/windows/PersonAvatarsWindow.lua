-- chunkname: @../../../Product/Bundles/Android/src/app/windows/PersonAvatarsWindow.lua
...
function PersonAvatarsWindow:layout()
	...
	self.changeSelectItem(self, tempAvatarID)
	self:initFilter()
end
...
function PersonAvatarsWindow:setButtonState()
	for i = 1, 2 do
		if i == self.curSelect then
			xyd.setUISpriteAsync(self.groupLabelImgArr[i], nil, "nav_btn_blue_" .. tostring(self.pos[i]), nil, nil)

			self.groupTextArr[i].color = Color.New2(4294967295)
			self.groupTextArr[i].effectColor = Color.New2(1012112383)
		else
			xyd.setUISpriteAsync(self.groupLabelImgArr[i], nil, "nav_btn_white_" .. tostring(self.pos[i]), nil, nil)

			self.groupTextArr[i].color = Color.New2(1012112383)
			self.groupTextArr[i].effectColor = Color.New2(4294967295)
		end
	end
	...
	if self.curSubSelect == 1 then
		xyd.setUISpriteAsync(self.btnHero_img, nil, "emotion_choose_btn", nil, nil)

		self.btnHero_label.color = Color.New2(4294967295)
		self.btnHero_label.effectColor = Color.New2(1012112383)

		xyd.setUISpriteAsync(self.btnSpecial_img, nil, "white_btn_0", nil, nil)

		self.btnSpecial_label.color = Color.New2(960513791)
		self.btnSpecial_label.effectColor = Color.New2(4294967295)
	else
		xyd.setUISpriteAsync(self.btnHero_img, nil, "white_btn_0", nil, nil)

		self.btnHero_label.color = Color.New2(960513791)
		self.btnHero_label.effectColor = Color.New2(4294967295)

		xyd.setUISpriteAsync(self.btnSpecial_img, nil, "emotion_choose_btn", nil, nil)

		self.btnSpecial_label.color = Color.New2(4294967295)
