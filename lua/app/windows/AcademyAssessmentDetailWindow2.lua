-- chunkname: @../../../Product/Bundles/Android/src/app/windows/AcademyAssessmentDetailWindow2.lua
...
function BigContent:registerEvent()
	UIEventListener.Get(self.helpBtn).onClick = function()
		if xyd.models.academyAssessment.seasonId >= tonumber(xyd.tables.miscTable:getNumber("school_practise_new_help_tips", "value")) then
