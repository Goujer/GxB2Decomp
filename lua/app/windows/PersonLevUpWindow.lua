-- chunkname: @../../../Product/Bundles/Android/src/app/windows/PersonLevUpWindow.lua
...
function PersonLevUpWindow:adaptX()
	...
	if screen.height > xyd.Global.getMaxBgHeight() then
	...
	elseif screen.height > xyd.Global.getMaxHeight() then
