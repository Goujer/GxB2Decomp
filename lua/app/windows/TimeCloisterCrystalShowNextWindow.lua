-- chunkname: @../../../Product/Bundles/Android/src/app/windows/TimeCloisterCrystalShowNextWindow.lua
...
function TimeCloisterCrystalShowNextWindow:layout()
	...
	xyd.setUISpriteAsync(self.maxIcon, nil, "pet_skill_max_" .. xyd.Global.lang, nil, nil, true)
