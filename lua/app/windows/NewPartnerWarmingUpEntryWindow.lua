-- chunkname: @../../../Product/Bundles/Android/src/app/windows/NewPartnerWarmingUpEntryWindow.lua
...
function NewPartnerWarmingUpEntryWindow:initUIComponent()
	xyd.setUISpriteAsync(self.textImg01, nil, "partner_preheat_text01_" .. xyd.Global.lang, nil, nil, true)
...
function NewPartnerWarmingUpEntryAwardItem:updateStates()
	if self.server_num_ >= xyd.tables.newPartnerWarmUpAwardTable:getAmount(self.id_) then
