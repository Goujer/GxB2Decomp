-- chunkname: @../../../Product/Bundles/Android/src/app/windows/SoulEquipInfoWindow.lua
...
function SoulEquipInfoWindow:register()
	...
	UIEventListener.Get(self.btnSaveCombination).onClick = function()
		...
		elseif xyd.models.slot:getSoulEquipCombinationNum() >= xyd.models.slot:getSoulEquipCombinationLimitNum() then
