-- chunkname: @../../../Product/Bundles/Android/src/app/windows/CollectionFaceDetailWindow.lua
...
function CollectionFaceDetailWindow:layout()
	xyd.setUISpriteAsync(self.emotionImg, nil, self.emoTable:getImg(self.id) .. "_big_png", nil, nil)
