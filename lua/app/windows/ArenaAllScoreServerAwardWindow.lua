-- chunkname: @../../../Product/Bundles/Android/src/app/windows/ArenaAllScoreServerAwardWindow.lua
...
function ArenaAllScoreServerAwardItem:update(_, info)
	...
	xyd.setUISpriteAsync(self.imgRank, nil, "as_rank_icon_" .. level, nil, nil, nil)
	...
	if self.id < 21 then
		...
		xyd.setUISpriteAsync(self.imgRank2, nil, img2_name, nil, nil, true)
	else
