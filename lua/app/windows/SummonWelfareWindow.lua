-- chunkname: @../../../Product/Bundles/Android/src/app/windows/SummonWelfareWindow.lua
...
function SummonWelfareWindow:layout()
	...
	xyd.setUISpriteAsync(self.titleImg, nil, "summon_welfare_text01_" .. tostring(xyd.Global.lang), nil, nil, true)
