-- chunkname: @../../../Product/Bundles/Android/src/app/windows/GuildCompetitionActiveWindow.lua
...
function GuildCompetitionActiveWindow:initTime()
	...
	if startTime < xyd.getServerTime() and endTime > xyd.getServerTime() then
...
function MissiosItem:getUIComponent()
	...
	xyd.setUISpriteAsync(self.imgAwardUISprite, nil, "mission_awarded_" .. xyd.Global.lang, nil, nil)
end
