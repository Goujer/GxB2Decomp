-- chunkname: @../../../Product/Bundles/Android/src/app/windows/TreasureBackWindow.lua
...
function TreasureBackWindow:initBtnIcon()
	...
	xyd.setUISpriteAsync(self.btnIcon, nil, "icon_" .. cost[1], nil, nil, nil)

	self.btnIconNum.text = cost[2]

	if cost[2] > xyd.models.backpack:getItemNumByID(cost[1]) then
		self.btnIconNum.color = Color.New2(3422556671)
		self.btnIconNum.effectColor = Color.New2(4294967295)
	else
		self.btnIconNum.color = Color.New2(4294967295)
