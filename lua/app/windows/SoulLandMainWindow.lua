-- chunkname: @../../../Product/Bundles/Android/src/app/windows/SoulLandMainWindow.lua
...
function SoulLandMainWindow:layout()
	...
	xyd.setUISpriteAsync(self.passBtnUISprite, nil, xyd.tables.activityTable:getIcon(xyd.ActivityID.SOUL_LAND_BATTLE_PASS), nil, nil, true)
	self:initTop()
	self:initTime()
	xyd.setUISpriteAsync(self.logoImg, nil, "soul_land_text_logo_" .. xyd.Global.lang)
	xyd.setUISpriteAsync(self.cardBtnNameImg, nil, "soul_land_text_jc_" .. xyd.Global.lang, nil, nil, true)
	xyd.setUISpriteAsync(self.shopBtnNameImg, nil, "soul_land_text_sd_" .. xyd.Global.lang, nil, nil, true)
	...
	for i = 1, #fortArr do
		...
		xyd.setUISpriteAsync(self["fortIcon" .. i], nil, fortEnterImg, nil, nil, true)
	end
