-- chunkname: @../../../Product/Bundles/Android/src/app/windows/QuickFormationWindow.lua
...
function QuickFormationWindow:updateNav()
	...
	for i = 1, teamNum do
		...
		if i == self.selectTeam then
			...
			self.navList_[i].label.color = Color.New2(4278124287)
			...
			self.navList_[i].label.effectColor = Color.New2(4294967295)
		end
	end
...
function QuickFormationWindow:saveTeamInfo()
	...
	for pos, partnerInfo in pairs(self.partnerInfos_[self.selectTeam]) do
		...
		params.partner_id = partnerInfo:getPartnerID()
		params.potentials = partnerInfo:getPotential()
		params.pos = pos
		params.skill_index = partnerInfo:getSkillIndex()
		params.equips = {}
