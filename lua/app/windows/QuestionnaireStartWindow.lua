-- chunkname: @../../../Product/Bundles/Android/src/app/windows/QuestionnaireStartWindow.lua
...
function QuestionnaireStartWindow:setLayout()
	...
	xyd.setUISpriteAsync(self.textImg_, "qustionnaire_web", "questionnaire_start_text01_" .. xyd.Global.lang, nil, nil, true)
	xyd.setUISpriteAsync(self.logo_, "qustionnaire_web", "questionnaire_start_text02_" .. xyd.Global.lang, nil, nil, true)
end
