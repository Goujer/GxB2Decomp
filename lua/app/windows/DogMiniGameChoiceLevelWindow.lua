-- chunkname: @../../../Product/Bundles/Android/src/app/windows/DogMiniGameChoiceLevelWindow.lua
...
function DogLevelItem:update(index, realIndex, info)
	...
	for i, data in pairs(awards) do
		...
		if xyd.models.selfPlayer:getDogMiniPassLevel() >= self.id then
