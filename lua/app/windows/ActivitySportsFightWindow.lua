-- chunkname: @../../../Product/Bundles/Android/src/app/windows/ActivitySportsFightWindow.lua
...
function ActivitySportsFightItem:update(index, params)
	...
	if params.group then
		xyd.setUISpriteAsync(self.groupImg, nil, "sports_group_shaddow_" .. tostring(params.group), nil, nil)
	end
end
...
function ActivitySportsFightWindow:sportsFight(event)
	...
	if self.matchData.fight_index > math.ceil(#self.matchData.match_infos / 5) then
		local msg = messages_pb:sports_get_match_infos_req()
