-- chunkname: @../../../Product/Bundles/Android/src/app/windows/PetTrainingLessonDetailWindow.lua
...
function PetChooseItem:onClickItem()
	...
	for _, id in ipairs(ids) do
		...
		if petInfo.lev == 0 or next(excludPets) and xyd.arrayIndexOf(excludPets, id) > 0 then
			-- block empty
		else
			count = count + 1
