-- chunkname: @../../../Product/Bundles/Android/src/app/windows/ActivityEntranceTestAddHeroWindow.lua
...
function ActivityEntranceTestAddHeroWindow:onClickheroIcon(heroIcon, isChoose, realIndex, item)
	if not isChoose then
		if #self.activityData.detail.partner_list >= xyd.tables.miscTable:getNumber("activity_warmup_arena_partner_limit", "value") then
