-- chunkname: @../../../Product/Bundles/Android/src/app/windows/ActivityPopularityVoteSupportRankWindow.lua
...
function RankItem:updateInfo()
	...
	if tonumber(self.rank) ~= nil and tonumber(self.rank) <= 3 then
		xyd.setUISpriteAsync(self.imgRankIcon, nil, "rank_icon0" .. self.rank, nil, nil)
