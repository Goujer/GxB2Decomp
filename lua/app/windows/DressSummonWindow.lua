-- chunkname: @../../../Product/Bundles/Android/src/app/windows/DressSummonWindow.lua
...
function NormalSummon:initAwardItems()
	...
	local showIDs1 = xyd.tables.dropboxShowTable:getIdsByBoxId(dropBoxId1) or {
		list = {}
	}
	local showIDs2 = xyd.tables.dropboxShowTable:getIdsByBoxId(dropBoxId2) or {
		list = {}
	}
...
function NormalSummon:onSummonResult(event)
	...
	name = #params == 1 and (haveCool and "dress_gacha_02" or "dress_gacha_01") or haveCool and "dress_gacha_04" or "dress_gacha_03"
...
function LimitSummon:initAwardItems(keepPosition)
	...
	local showIDs = xyd.tables.dropboxShowTable:getIdsByBoxId(dropBoxId) or {
		list = {}
	}
