-- chunkname: @../../../Product/Bundles/Android/src/app/windows/DungeonWindow.lua
...
function DungeonWindow:changeBtnFightStatus(flag)
	...
	if flag and self.dungeon:checkHasAlive() and self.dungeon:getMaxStage() >= self.dungeon:getCurStage() then
