-- chunkname: @../../../Product/Bundles/Android/src/app/windows/StoryListWindow.lua
...
function StoryListWindow:initTopGroup()
	self.windowTop = WindowTop.new(self.topGroup, self.name_, nil, nil, function()
		...
		elseif self.layer_type == TYPE2.LIST then
...
function HeroListWindowItem:onClickFortItem()
	...
	if self.maxStage == 0 then
		...
		params.message = __("HERO_CHALLENGE_TIPS40")
