-- chunkname: @../../../Product/Bundles/Android/src/app/windows/ActivityChildhoodShopGachaWindow.lua
...
function ActivityChildhoodShopGachaWindow:updateRed()
	if self.gachaCost[2] > xyd.models.backpack:getItemNumByID(self.gachaCost[1]) then
		self.btnGacha1RedMark:SetActive(false)
	else
		self.btnGacha1RedMark:SetActive(true)
	end

	if self.gachaCost[2] * 10 > xyd.models.backpack:getItemNumByID(self.gachaCost[1]) then
...
function ActivityChildhoodShopGachaWindow:gacha(num)
	...
	if self.gachaCost[2] * num > xyd.models.backpack:getItemNumByID(self.gachaCost[1]) then
