-- chunkname: @../../../Product/Bundles/Android/src/app/windows/TowerRecordWindow.lua
...
function TowerRecordWindow:setLayout()
	...
	if self.start_stage == 0 or self.end_stage == 0 or self.start_stage > self.end_stage then
