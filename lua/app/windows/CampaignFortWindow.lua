-- chunkname: @../../../Product/Bundles/Android/src/app/windows/CampaignFortWindow.lua
...
function FortItem:onClickFortItem()
	...
	elseif self.fortId == self.currentFortID then
		...
		if need_lv > xyd.models.backpack:getLev() then
