-- chunkname: @../../../Product/Bundles/Android/src/app/windows/TimeCloisterCardRecordWindow.lua
...
function TimeCloisterCardRecordWindow:layout()
	...
	for id, value in pairs(events) do
		...
		if type and type > 0 and (type == xyd.TimeCloisterCardType.ENCOUNTER_BATTLE or type == xyd.TimeCloisterCardType.DRESS_MISSION_EVENT) then
			-- block empty
		else
			table.insert(ids, {
				card_id = tonumber(id),
