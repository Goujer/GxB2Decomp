-- chunkname: @../../../Product/Bundles/Android/src/app/windows/ActivityLassoAwardsWindow.lua
...
function AwardItem:initUI()
	...
	xyd.setUISpriteAsync(self.theTurn, nil, "anniversary_cake_current_turn_" .. xyd.Global.lang, nil, nil, true)
