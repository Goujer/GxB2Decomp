-- chunkname: @../../../Product/Bundles/Android/src/app/windows/AdventureBoxPreviewWindow.lua
...
function AdventureBoxPreviewWindow:setBoxs()
	...
	if tonumber(costAll[2]) > xyd.models.backpack:getItemNumByID(tonumber(costAll[1])) then
