-- chunkname: @../../../Product/Bundles/Android/src/app/windows/Arena3V3ResultWindow.lua
...
function Arena3V3ResultWindow:initArenaScore()
	...
	if level == 21 then
		...
		xyd.setUISpriteAsync(self.levelLImg, nil, "as_rank_icon_5", nil, nil, true)
	elseif level == 22 then
		self.levelLImg2.gameObject:SetActive(false)
		xyd.setUISpriteAsync(self.levelLImg, nil, "as_rank_icon_6", nil, nil, true)
	else
		local level_ = math.fmod(level - 1, 5) + 1

		self.levelLImg2.gameObject:SetActive(true)
		xyd.setUISpriteAsync(self.levelLImg, nil, "as_rank_icon_" .. rankType, nil, nil, true)
		xyd.setUISpriteAsync(self.levelLImg2, nil, "as_rank_icon_" .. rankType .. "_" .. level_, nil, nil, true)
	end
	...
	if level == 21 then
		...
		xyd.setUISpriteAsync(self.levelRImg, nil, "as_rank_icon_5", nil, nil, true)
	elseif level == 22 then
		self.levelRImg2.gameObject:SetActive(false)
		xyd.setUISpriteAsync(self.levelRImg, nil, "as_rank_icon_6", nil, nil, true)
	else
		local level_ = math.fmod(level - 1, 5) + 1

		self.levelRImg2.gameObject:SetActive(true)
		xyd.setUISpriteAsync(self.levelRImg, nil, "as_rank_icon_" .. rankType, nil, nil, true)
		xyd.setUISpriteAsync(self.levelRImg2, nil, "as_rank_icon_" .. rankType .. "_" .. level_, nil, nil, true)
	end
