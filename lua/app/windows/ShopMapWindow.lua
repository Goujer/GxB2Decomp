-- chunkname: @../../../Product/Bundles/Android/src/app/windows/ShopMapWindow.lua
...
function ShopMapWindow:onNoOpenTouch()
	...
	params.message = __("SHOP_STREET_TEXT01")
...
function ShopMapWindow:updateUpIcon()
	if xyd.models.activity:isResidentReturnAddTime() then
		...
		xyd.setUISpriteAsync(self.shopMarket_upIcon.gameObject:GetComponent(typeof(UISprite)), nil, "common_tips_up_" .. return_multiple, nil, nil, nil)
	else
