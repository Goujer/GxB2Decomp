-- chunkname: @../../../Product/Bundles/Android/src/app/windows/AchievementWindow.lua
...
function AchievementWindow:layout()
	xyd.setUITextureAsync(self.textureTop_, "Textures/achieve_web/achieve_top_bg", nil, nil)
	self:register()
