-- chunkname: @../../../Product/Bundles/Android/src/app/windows/FriendBossMyAssistantSettingWindow.lua
...
function FriendBossMyAssistantSettingWindow:onClickheroIcon(heroIcon, needUpdate, isChoose, needAnimation, posId)
	...
	if self.selectedPartnerId ~= nil then
		if self.selectedPartnerId == heroInfo.partnerID and (not needAnimation or true) then
