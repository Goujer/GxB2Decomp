-- chunkname: @../../../Product/Bundles/Android/src/app/windows/ArcticExpeditionRecordWindow.lua
...
function ArcticExpeditionRecordItem:setInfo(params, cell_id, self_info, index)
	...
	elseif index > self.parent_.changeNum then
		self.resultLabel.text = __("ARCTIC_EXPEDITION_TEXT_17")
	else
...
function ArcticExpeditionRecordItem:setState(state)
	if state == 1 then
		...
		self.matchNum.effectColor = Color.New2(2742695167)
	else
