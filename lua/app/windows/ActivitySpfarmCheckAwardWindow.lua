-- chunkname: @../../../Product/Bundles/Android/src/app/windows/ActivitySpfarmCheckAwardWindow.lua
...
function SpaceExploreAwardItem:update(_, _, id)
	...
	if is_awarded or levelNow < level then
		-- block empty
	else
		function funcClick()
	...
	for i = #famousLevelArr, 1, -1 do
		if level >= famousLevelArr[i] then
