-- chunkname: @../../../Product/Bundles/Android/src/app/windows/ActivityExploreOldCampusWayBuyWindow.lua
...
function ActivityExploreOldCampusWayBuyWindow:onClickBuy()
	...
	if costNum > xyd.models.backpack:getItemNumByID(xyd.ItemID.OLD_BUILDING_CARD) then
...
function ActivityExploreOldCampusWayBuyWindow:updateSkillInfo()
	...
	if cost[2] > xyd.models.backpack:getItemNumByID(xyd.ItemID.OLD_BUILDING_CARD) then
		self.costLabel_.color = Color.New2(4278190335)
	else
