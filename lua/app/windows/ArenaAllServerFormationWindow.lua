-- chunkname: @../../../Product/Bundles/Android/src/app/windows/ArenaAllServerFormationWindow.lua
...
function ArenaAllServerFormationWindow:initPartnerPart()
	...
	for i = 1, #self.dataInfo.teams.partners do
		if not self.dataInfo.teams.partners[i].table_id or tonumber(self.dataInfo.teams.partners[i].table_id) == 0 then
			-- block empty
		else
