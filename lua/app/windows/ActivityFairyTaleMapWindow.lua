-- chunkname: @../../../Product/Bundles/Android/src/app/windows/ActivityFairyTaleMapWindow.lua
...
function ActivityFairyTaleMapWindow:onCellChallenge(event)
	...
	if cellType == CellType.BOSS or cellType == CellType.BATTLE then
		-- block empty
	elseif cellType == CellType.HELP then
		xyd.itemFloat(items, nil, nil, 5000)
...
function CellItem:refreshState()
	if self.isUnlock_ == 1 then
		...
		self.go:GetComponent(typeof(UISprite)).color = Color.New2(4294967295)
	else
		self.lockImg_:SetActive(true)
		self.cellImg_:SetActive(false)

		self.go:GetComponent(typeof(UISprite)).color = Color.New2(3452816895)
	end
	...
	local labelColor = {
		...
		{
			effectColor = Color.New2(3245424127)
		},
		{
			effectColor = Color.New2(2154779135)
		},
		{
			effectColor = Color.New2(746892543)
		},
		{
			effectColor = Color.New2(2406439423)
		},
		{
