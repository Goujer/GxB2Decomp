-- chunkname: @../../../Product/Bundles/Android/src/app/windows/TimeCloisterSpeedUpWindow.lua
...
function TimeCloisterSpeedUpWindow:registerEvent()
	...
	UIEventListener.Get(self.btnSure).onClick = function()
		...
		if cradJumpTimeDis > math.floor(energy * cradEnergyTime + 0.05) then
		...
		elseif self.buyNum > 0 then
			...
			if leftTime < cradJumpTimeDis then
				sendNum = sendNum - 1
