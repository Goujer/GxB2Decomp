-- chunkname: @../../../Product/Bundles/Android/src/app/windows/CampaignStageDetailWindow.lua
...
function CampaignStageDetailWindow:updateUpIcon()
	for i = 1, 2 do
		if xyd.models.activity:isResidentReturnAddTime() then
			...
			xyd.setUISpriteAsync(self["upIcon" .. i].gameObject:GetComponent(typeof(UISprite)), nil, "common_tips_up_" .. return_multiple, nil, nil, nil)
		else
			self["upIcon" .. i]:SetActive(xyd.getReturnBackIsDoubleTime())
			xyd.setUISpriteAsync(self["upIcon" .. i].gameObject:GetComponent(typeof(UISprite)), nil, "common_tips_up_2", nil, nil, nil)
		end
