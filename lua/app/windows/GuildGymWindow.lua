-- chunkname: @../../../Product/Bundles/Android/src/app/windows/GuildGymWindow.lua
...
function GuildGymWindow:nextPage()
	if self.currPageNum + 1 > self.maxPageNum then
		return
	end
...
function GuildBossCard:initBossStatus()
	...
	if self.pageNum_ == 0 or self.bossId_ > self.maxID_ then
