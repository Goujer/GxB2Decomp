-- chunkname: @../../../Product/Bundles/Android/src/app/windows/FairArenaEntryWindow.lua
...
function FairArenaEntryWindow:initUIComponent()
	xyd.setUISpriteAsync(self.textImg01_, nil, "fair_arena_text01_" .. xyd.Global.lang, nil, nil, true)
	xyd.setUISpriteAsync(self.textImg02_, nil, "fair_arena_main_btn_text01_" .. xyd.Global.lang, nil, nil, true)
	xyd.setUISpriteAsync(self.textImg03_, nil, "fair_arena_main_btn_text02_" .. xyd.Global.lang, nil, nil, true)
...
function FairArenaEntryWindow:updateLayout(event)
	...
	if leftTime > xyd.TimePeriod.DAY_TIME then
