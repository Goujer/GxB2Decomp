-- chunkname: @../../../Product/Bundles/Android/src/app/windows/ActivityRechargeLotteryMissionWindow.lua
...
function ActivityRechargeLotteryMissionWindow:initUIComponent()
	xyd.setUISpriteAsync(self.imgText, nil, "activity_recharge_lottery_ljjl_" .. xyd.Global.lang, nil, nil, true)
	...
	table.sort(data, function(a, b)
		local isCompleteA = a.vipExp >= a.vipExpNeed and 1 or 0
		local isCompleteB = b.vipExp >= b.vipExpNeed and 1 or 0
...
function ActivityRechargeLotteryMissionWindowItem:setInfo(params)
	...
	if params.vipExp >= params.vipExpNeed then
		icon:setChoose(true)
	end
end
