-- chunkname: @../../../Product/Bundles/Android/src/app/windows/ActivityDragonBoatAwardSelectWindow.lua
...
function ActivityDragonBoatAwardSelectWindow:updateNextBtn()
	...
	if num and flag or self.exAwards[self.curIndex] and num > self.curIndex or self.id == freeId and self.exAwards[self.curIndex] then
