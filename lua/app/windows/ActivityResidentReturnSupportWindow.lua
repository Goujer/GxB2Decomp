-- chunkname: @../../../Product/Bundles/Android/src/app/windows/ActivityResidentReturnSupportWindow.lua
...
function ActivityResidentReturnSupportWindow:initTopGroup()
	...
	self.windowTop = WindowTop.new(self.window_, self.name_, nil, nil, callback)
...
function ActivityResidentReturnSupportWindow:initUIComponent()
	xyd.setUISpriteAsync(self.textImg_, nil, "resident_return_support_logo_" .. xyd.Global.lang, nil, nil, true)
