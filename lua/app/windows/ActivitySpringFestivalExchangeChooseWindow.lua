-- chunkname: @../../../Product/Bundles/Android/src/app/windows/ActivitySpringFestivalExchangeChooseWindow.lua
...
function Choose_Item:updateGrey()
	...
	if activityData and activityData.detail.buy_times[self.parent_.group_id][self.id] >= xyd.tables.activitySpringFestivalAwardTble:getLimit(self.parent_.group_id)[self.id] then
