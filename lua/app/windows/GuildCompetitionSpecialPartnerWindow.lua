-- chunkname: @../../../Product/Bundles/Android/src/app/windows/GuildCompetitionSpecialPartnerWindow.lua
...
function GuildCompetitionSpecialPartnerWindow:getUIComponent()
	...
	xyd.setUISpriteAsync(skill_bg_sprite, nil, "9gongge23", nil, nil, nil)
	...
	xyd.setUISpriteAsync(self.closeBtnNew_sprite, nil, "close_btn", nil, nil, nil)
...
function GuildCompetitionSpecialPartnerWindow:changeCommonUI()
	...
	xyd.setUISpriteAsync(self.detailBg_UISprite, nil, "9gongge26", nil, nil, nil)
