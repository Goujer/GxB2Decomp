-- chunkname: @../../../Product/Bundles/Android/src/app/windows/Activity2LoveWindow.lua
...
function Activity2LoveWindow:updateBtnType()
	...
	elseif self.isCost_ and tonumber(self.isCost_) == 1 then
		...
		if self.activityData.detail.free_count == 0 then
			...
			self.sureBtnRed_:SetActive(xyd.models.backpack:getItemNumByID(tonumber(self.cost_[1])) >= tonumber(self.cost_[2]))
		end
