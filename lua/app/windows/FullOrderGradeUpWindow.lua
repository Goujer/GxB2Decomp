-- chunkname: @../../../Product/Bundles/Android/src/app/windows/FullOrderGradeUpWindow.lua
...
function FullOrderGradeUpWindow:initResItem()
	...
	for i = 1, 3 do
		if self.costs[i] > self.owns[i] then
			self["costItem" .. i]:ComponentByName("labelCost", typeof(UILabel)).color = Color.New2(3422556671)
		else
