-- chunkname: @../../../Product/Bundles/Android/src/app/windows/ActivityPirateStoryListWindow.lua
...
function ActivityPirateStoryListWindow:getUIComponent()
	...
	for i = 1, 11 do
		...
		if self:checkFinish(story_id) then
			...
			xyd.setUISpriteAsync(img, nil, "activity_pirate_story_item_bg" .. type, nil, nil, true)
			...
			xyd.setUISpriteAsync(img, nil, "activity_pirate_story_item_bg0", nil, nil, true)
