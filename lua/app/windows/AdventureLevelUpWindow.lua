-- chunkname: @../../../Product/Bundles/Android/src/app/windows/AdventureLevelUpWindow.lua
...
function AdventureLevelUpWindow:updateContent()
	...
	if curLv < adventureMaxLevel then
		...
		self.labelLevel2.color = Color.New2(4160023551)
		...
		for i = 1, 3 do
			self.labelItemList2[i].labelName.color = Color.New2(2795939583)
			self.labelItemList2[i].labelNum.color = Color.New2(2795939583)
		end
