-- chunkname: @../../../Product/Bundles/Android/src/app/windows/DressShowEntranceWindow.lua
...
function DressShowEntranceWindow:layout()
	...
	xyd.setUISpriteAsync(self.logoImg_, nil, "dress_show_logo_" .. xyd.Global.lang, nil, nil, true)
...
function DressShowEntranceWindow:updateShowCase()
	for i = 1, 4 do
		...
		if not xyd.checkFunctionOpen(function_id, true) then
			...
			xyd.setUISpriteAsync(self["entranceState" .. i], nil, "memory_list_lock", nil, nil, true)
		else
			...
			xyd.setUISpriteAsync(self["entranceState" .. i], nil, "dress_show_level_" .. level, nil, nil, true)
		end
	end
end
