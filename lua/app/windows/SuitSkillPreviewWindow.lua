-- chunkname: @../../../Product/Bundles/Android/src/app/windows/SuitSkillPreviewWindow.lua
...
function SuitSkillPreviewWindow:initSkillItem()
	...
	if self.levelUp == 1 then
		self.descLabel1.color = Color.New2(2155905279)
		self.descLabel2.color = Color.New2(2155905279)
		...
		for i = 1, 3 do
			if self.levelUp ~= i then
				self["descLabel" .. i].color = Color.New2(2155905279)
			end
		end
	end
end
