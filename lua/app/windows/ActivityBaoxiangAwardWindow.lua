-- chunkname: @../../../Product/Bundles/Android/src/app/windows/ActivityBaoxiangAwardWindow.lua
...
function ActivityBaoxiangAwardWindow:setContent()
	...
	for i = 1, #ids do
		...
		local canAward = value >= xyd.tables.activityNewyearAwardTable:getPoint(id) and 1 or 0
