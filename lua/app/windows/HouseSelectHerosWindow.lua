-- chunkname: @../../../Product/Bundles/Android/src/app/windows/HouseSelectHerosWindow.lua
...
function HouseSelectHerosWindow:layout()
	...
	xyd.setUISpriteAsync(self.imgStay, nil, source, nil, nil, true)
...
function HouseSelectHerosWindow:changeFloor(index)
	if index > self.openDormNum then
