-- chunkname: @../../../Product/Bundles/Android/src/app/windows/TenStarExchangeWindow.lua
...
function TenStarExchangeWindow:initData()
	...
	if self.itemCost_ > xyd.models.backpack:getItemNumByID(xyd.ItemID.TEN_STAR_EXCHANGE_MATERIAL) then
		self.exchangeBtnCostLabel_.color = Color.New2(3422556671)
		self.exchangeBtnCostLabel_.effectColor = Color.New2(68719476735)
	else
		self.exchangeBtnCostLabel_.color = Color.New2(4294967295)
...
function TenStarExchangeWindow:initFiveStarIcon()
	...
	self.countLabel2_.color = Color.New2(3422556671)
	self.countLabel2_.effectColor = Color.New2(68719476735)
	self.typicalPartner_ = nil
