-- chunkname: @../../../Product/Bundles/Android/src/app/windows/ActivityFireworkShopWindow.lua
...
function ActivityFireworkShopWindow:updateNavShow()
	...
	for i = 1, MAX_NUM do
		...
		if costNum < num then
			...
			unChosenImg = i == 1 and "nav_btn_white_left" or i == MAX_NUM and "nav_btn_white_right" or "nav_btn_white_mid"
		end
