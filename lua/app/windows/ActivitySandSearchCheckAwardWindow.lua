-- chunkname: @../../../Product/Bundles/Android/src/app/windows/ActivitySandSearchCheckAwardWindow.lua
...
function AwardItem:update(_, id)
	...
	for i = 1, 3 do
		...
		self:waitForFrame(1, function()
			...
			if (stage_id > id or stage_id == id and point >= pointStage[i]) and id < 31 then
