-- chunkname: @../../../Product/Bundles/Android/src/app/windows/TimeCloisterAchievementWindow.lua
...
function MissionItem:initUI()
	...
	xyd.setUISpriteAsync(self.awardImg, nil, "mission_awarded_" .. xyd.Global.lang, nil, nil)
...
function MissionItem:updateInfo()
	...
	if style == 2 then
		...
		if tonumber(dataValue) > tonumber(completeValue) then
	...
	if completeValue > tonumber(dataValue) then
