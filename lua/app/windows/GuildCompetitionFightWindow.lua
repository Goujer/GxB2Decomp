-- chunkname: @../../../Product/Bundles/Android/src/app/windows/GuildCompetitionFightWindow.lua
...
function GuildCompetitionFightWindow:checkTipsShow()
	...
	if lastTipsTime then
		...
		if lastTipsTime < guildCompetitionData:startTime() or lastTipsTime >= guildCompetitionData:getEndTime() then
			for i = 1, 3 do
