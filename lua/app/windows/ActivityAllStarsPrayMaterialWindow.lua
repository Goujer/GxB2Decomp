-- chunkname: @../../../Product/Bundles/Android/src/app/windows/ActivityAllStarsPrayMaterialWindow.lua
...
function ActivityAllStarsPrayMaterialWindow:layout()
	xyd.setUISpriteAsync(self.iconImg_, nil, xyd.tables.itemTable:getIcon(111), nil, nil)
