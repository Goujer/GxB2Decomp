-- chunkname: @../../../Product/Bundles/Android/src/app/windows/FriendTeamBossInviteFriendsWindow.lua
...
function FriendTeamBossInviteFriendsWindow:sortFriend(list)
	...
	table.sort(lst, function(a, b)
		...
		if aPower > xyd.models.arena:getPower() or bPower > xyd.models.arena:getPower() then
...
function FriendTeamBossInviteFriendItem:layout()
	...
	if power > xyd.models.arena:getPower() then
		str = __("TIP_STRONG")
