-- chunkname: @../../../Product/Bundles/Android/src/app/windows/ActivityRechargeLotteryWindow.lua
...
function ActivityRechargeLotteryWindow:initUIComponent()
	xyd.setUISpriteAsync(self.imgText, nil, "activity_recharge_lottery_logo_" .. xyd.Global.lang, nil, nil, true)
...
function ActivityRechargeLotteryWindow:register()
	...
	self.eventProxy_:addEventListener(xyd.event.GET_ACTIVITY_AWARD, function(event)
		...
		if self.isSkipAni == 1 then
			...
			local fastAniFunction, slowAniFunction
