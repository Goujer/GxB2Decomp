-- chunkname: @../../../Product/Bundles/Android/src/app/windows/PersonEditNameWindow.lua
...
function PersonEditNameWindow:layout()
	...
	self.btnSureLabelCost_.color = Color.New2(4294967295)
	self.btnSureLabelCost_.effectColor = Color.New2(1012112383)

	if not self:checkEnough() then
		self.btnSureLabelCost_.color = Color.New2(3422556671)
		self.btnSureLabelCost_.effectColor = Color.New2(4294967295)
	end
