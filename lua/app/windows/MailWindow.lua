-- chunkname: @../../../Product/Bundles/Android/src/app/windows/MailWindow.lua
...
function MailWindow:setMailBtn()
	...
	if str == "System" then
		...
		xyd.setUISpriteAsync(self.btnSystem_, nil, "mail_label02", nil, nil)
		xyd.setUISpriteAsync(self.btnSystemImg_, nil, "mail_sys01", nil, nil)
		xyd.setUISpriteAsync(self.btnFriend_, nil, "mail_label01", nil, nil)
		xyd.setUISpriteAsync(self.btnFriendImg_, nil, "mail_friend02", nil, nil)
		xyd.setUISpriteAsync(self.btnGM_, nil, "mail_label01", nil, nil)
		xyd.setUISpriteAsync(self.btnGMImg_, nil, "mail_gm02", nil, nil)
		self:updateClaimBtn()
	elseif str == "Friend" then
		xyd.setUISpriteAsync(self.btnSystem_, nil, "mail_label01", nil, nil)
		xyd.setUISpriteAsync(self.btnSystemImg_, nil, "mail_sys02", nil, nil)
		xyd.setUISpriteAsync(self.btnFriend_, nil, "mail_label02", nil, nil)
		xyd.setUISpriteAsync(self.btnFriendImg_, nil, "mail_friend01", nil, nil)
		xyd.setUISpriteAsync(self.btnGM_, nil, "mail_label01", nil, nil)
		xyd.setUISpriteAsync(self.btnGMImg_, nil, "mail_gm02", nil, nil)
	else
		xyd.setUISpriteAsync(self.btnSystem_, nil, "mail_label01", nil, nil)
		...
		xyd.setUISpriteAsync(self.btnFriend_, nil, "mail_label01", nil, nil)
		xyd.setUISpriteAsync(self.btnFriendImg_, nil, "mail_friend02", nil, nil)
		xyd.setUISpriteAsync(self.btnGM_, nil, "mail_label02", nil, nil)
		xyd.setUISpriteAsync(self.btnGMImg_, nil, "mail_gm01", nil, nil)
	end
end
	...
	for _, id in ipairs(datas) do
		...
		if mail and mail.attach and #mail.attach > 0 then
			for _, item in ipairs(mail.attach) do
				...
				itemInfo.hideText = true
				itemInfo.item_id = item.item_id
				itemInfo.item_num = item.item_num
...
function MailItem:setInfo(info)
	...
	if self.mail_.mail_id ~= 99999 then
		xyd.setUISpriteAsync(self.bg_select_mail, nil, "mail_text01_" .. xyd.Global.lang, nil, nil, true)
		xyd.setUISpriteAsync(self.bg_gray_mail, nil, "mail_text02_" .. xyd.Global.lang, nil, nil, true)
		xyd.setUISpriteAsync(self.bg_new_mail, nil, "mail_icon05", nil, nil, true)
		...
		xyd.setUISpriteAsync(self.bg_gray_mail, nil, "activity_year_summary_mail_bg2_" .. xyd.Global.lang, nil, nil, true)
		xyd.setUISpriteAsync(self.bg_new_mail, nil, "activity_year_summary_mail_bg", nil, nil, true)
...
function MailItem:setCommonState()
	if self.mail_.is_read == 0 then
		...
		self.label_title.effectColor = Color.New2(4294967295)
		self.label_name.color = Color.New2(1432789759)
		self.label_name.effectColor = Color.New2(4294967295)
	...
	elseif self.mail_.mail_id == 99999 and self.mail_.is_read == 1 then
		...
		self.label_title.effectColor = Color.New2(3991793151)
		self.label_name.color = Color.New2(1819045119)
		self.label_name.effectColor = Color.New2(3991793151)
	...
	if self.mail_.mail_id == 99999 then
		self.label_title.color = Color.New2(3983902463)
		self.label_title.effectColor = Color.New2(4294967295)
		self.label_data.color = Color.New2(2155905279)
		self.label_data.effectColor = Color.New2(4294967295)
	end
end
