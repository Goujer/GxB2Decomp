-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/SpringGiftBag.lua
...
function SpringGiftBag:initUIComponent()
	xyd.setUISpriteAsync(self.textImg, nil, "spring_gfitbag_text_" .. xyd.Global.lang, nil, nil, true)
