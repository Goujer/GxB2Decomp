-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/ActivityScratchCard.lua
...
function ActivityScratchCard:onClickBtn(count)
	if count > xyd.models.backpack:getItemNumByID(xyd.ItemID.SCRATCH_CARD_TICKET) then
