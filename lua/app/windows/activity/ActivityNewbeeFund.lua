-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/ActivityNewbeeFund.lua
...
function ActivityNewbeeFund:onRegister()
	...
	UIEventListener.Get(self.helpBtn).onClick = function()
		...
		key = self.isNew_ and "ACTIVITY_NEWBEE_FUND_HELP" or "ACTIVITY_YEAR_FUND_HELP"
