-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/ActivityCrystalGift.lua
...
function ActivityCrystalGift:setText()
	...
	xyd.setUISpriteAsync(self.titleImg, nil, "activity_crystal_gift_" .. xyd.Global.lang, nil, nil, true)
end
	...
	table.sort(collection_, function(a, b)
		if a.hasBuy == b.hasBuy then
			if a.isCrtstal == b.isCrtstal then
				...
				return xyd.bool2Num(a.isCrtstal) > xyd.bool2Num(b.isCrtstal)
			end
		else
