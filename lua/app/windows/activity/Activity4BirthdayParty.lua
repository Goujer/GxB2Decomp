-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/Activity4BirthdayParty.lua
...
function Activity4BirthdayParty:initUIComponent()
	...
	xyd.setUISpriteAsync(self.btnSwitch2, nil, "activity_4birthday_party_bg_fh_" .. xyd.Global.lang, nil, nil, true)
	self:initData()
	self:updateContent()
...
function Activity4BirthdayParty:updateSpeciaAwardGroup()
	...
	if needPoint <= allPoint then
		xyd.setUISpriteAsync(self.btnSwitch1, nil, "activity_4birthday_party_bg_whkh_" .. xyd.Global.lang, nil, nil, true)
		self.btnSwitch1:NodeByName("imgGroup").gameObject:SetActive(true)
	else
		xyd.setUISpriteAsync(self.btnSwitch1, nil, "activity_4birthday_party_bg_yhrd_" .. xyd.Global.lang, nil, nil, true)
