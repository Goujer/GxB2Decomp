-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/DarkGuard.lua
...
function DarkGuard:initPlayTextGroup()
	...
	do
		local ____TS_obj, ____TS_index = self.nextPageImg, "y"
...
function DarkGuard:playText(skip, same)
	...
	if animationType == nil or animationType == nil then
		-- block empty
...
function DarkGuard:playTextEffect()
	self.curTimeoutId = egret:setTimeout(function()
		do
			local ____TS_obj, ____TS_index = self.printerLabel, "text"
