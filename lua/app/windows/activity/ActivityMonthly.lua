-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/ActivityMonthly.lua
...
function ActivityMonthly:euiComplete()
	...
	xyd.setUISpriteAsync(self.textImg, nil, "activity_monthly_text01_" .. tostring(xyd.Global.lang), nil, nil, true)
...
function ActivityMonthly:initItem()
	...
	for i, v in pairs(ids) do
		...
		if self:getIsAward(id) and self:getIsAward(id) >= 0 then
			...
			if id == 7 and xyd.getServerTime() < tonumber(specialTime) or id == 5 then
				-- block empty
