-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/BindAccountEntryWindow.lua
...
function BindAccountEntryWindow:updateStatus()
	...
	if status == 0 then
		...
		xyd.setUISpriteAsync(self.bindBtn_uiSprite, nil, "mana_week_card_btn01", nil, nil)

		self.button_label.color = Color.New2(3224980479)
		self.button_label.effectColor = Color.New2(4294967295)
	elseif status == 1 then
		self.maskImg:SetActive(false)

		self.button_label.text = __("GET2")

		xyd.setUISpriteAsync(self.bindBtn_uiSprite, nil, "green_btn_192_67", nil, nil)

		self.button_label.color = Color.New2(4294967295)
