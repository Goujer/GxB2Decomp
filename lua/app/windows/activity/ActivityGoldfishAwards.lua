-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/ActivityGoldfishAwards.lua
...
function ActivityGoldfishAwards:initUIComponent()
	xyd.setUISpriteAsync(self.textImg, nil, "goldfish_awards_title_" .. xyd.Global.lang, nil, nil)
	self:setText()
