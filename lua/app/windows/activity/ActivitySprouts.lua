-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/ActivitySprouts.lua
...
function ActivitySprouts:initUIComponent()
	xyd.setUISpriteAsync(self.imgTitle, nil, "activity_sprouts_text_" .. xyd.Global.lang, nil, nil, true)
...
function ActivitySprouts:onAward(event)
	...
	xyd.alertTips(__("ACTIVITY_SPROUTTS_GROW", height), nil, nil, nil, nil, nil, 300)
	self:growAnimation()
	self:update()
end
