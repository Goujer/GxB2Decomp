-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/NewSevendayGiftbag.lua
...
function NewSevendayGiftbag:initUIComponent()
	xyd.setUISpriteAsync(self.textImg_, nil, "new_seven_giftbag_text01_" .. xyd.Global.lang, nil, nil, true)
