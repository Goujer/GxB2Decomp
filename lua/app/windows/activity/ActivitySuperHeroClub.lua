-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/ActivitySuperHeroClub.lua
...
function ActivitySuperHeroClub:getUIComponent()
	...
	self.preBtn_button_label.effectColor = Color.New2(4294967295)
	...
	self.okBtn_button_label.color = Color.New2(2975269119)
	self.okBtn_button_label.effectColor = Color.New2(4294967295)
...
function ActivitySuperHeroClub:initUITexture()
	...
	xyd.setUISpriteAsync(self.titleImg, nil, "super_hero_club_logo_" .. tostring(xyd.Global.lang), nil, nil, true)
...
function ActivitySuperHeroClub:updateTimeLabel()
	...
	if self:getRetTime() < 0 then
		...
		if self.timeText then
			self.timeText.text = xyd.secondsToString(self.getRetTime(self))
		end
