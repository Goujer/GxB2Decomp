-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/ActivityPuppet.lua
...
function ActivityPuppet:layout()
	...
	if self.activityData:getUpdateTime() > xyd.getServerTime() then
		if xyd.Global.lang == "fr_fr" then
			self.timeLabel.color = Color.New2(3733089279)
			self.endLabel.color = Color.New2(3979052031)
...
function ActivityPuppet:initMission(isInit)
	...
	for i = 1, #ids do
		...
		local params = {
			...
			isCompleted = xyd.models.backpack:getItemNumByID(xyd.ItemID.JOKER_PUPPET) >= xyd.tables.activityPuppetTable:getPoint(id),
