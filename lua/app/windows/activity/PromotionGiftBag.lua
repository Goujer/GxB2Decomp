-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/PromotionGiftBag.lua
...
function PromotionGiftBag:initUI()
	...
	if xyd.Global.lang == "fr_fr" then
		self.timeLabel_.color = Color.New2(2784231423)
		self.endLabel_.color = Color.New2(2684334079)
