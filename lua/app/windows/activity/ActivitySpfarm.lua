-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/ActivitySpfarm.lua
...
function ActivitySpfarm:initChat()
	...
	for i, id in pairs(ids) do
		if curDay >= xyd.tables.activitySpfarmDialogTable:getTime(id) and totalLev >= xyd.tables.activitySpfarmDialogTable:getLevel(id) then
