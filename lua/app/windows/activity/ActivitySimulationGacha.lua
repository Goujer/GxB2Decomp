-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/ActivitySimulationGacha.lua
...
function ActivitySimulationGacha:initUIComponent()
	xyd.setUISpriteAsync(self.imgText, nil, "activity_simulation_gacha_text_" .. xyd.Global.lang, nil, nil, true)
	xyd.setUISpriteAsync(self.imgTip, nil, "activity_simulation_gacha_tip_" .. xyd.Global.lang, nil, nil, true)
	...
	if flashBack and flashBack == 1 and self.activityData.detail.tmp_slot and #self.activityData.detail.tmp_slot > 0 then
		local params = {
			...
			btnSummonRightLabelColor = Color.New2(4294967295),
