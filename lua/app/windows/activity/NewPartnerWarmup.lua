-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/NewPartnerWarmup.lua
...
function NewPartnerWarmup:initUIComponent()
	xyd.setUISpriteAsync(self.imgText, nil, "new_partner_warmup_text_" .. xyd.Global.lang, nil, nil, true)
...
function NewPartnerWarmup:register()
	...
	for i = 1, 3 do
		local function clickFunc()
			...
			elseif self.activityData.detail.current_stage > i or self.activityData.detail.current_stage == -1 then
