-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/ActivityRepairConsole.lua
						...
						xyd.openWindow("gamble_rewards_window", {
							...
							callback = function()
								...
								if self.activityData.onOpenNextRound then
									...
									end, __("ACTIVITY_REPAIR_CONSOLE_TEXT11"), false, {}, nil, nil, nil, nil, nil, nil, __("ACTIVITY_REPAIR_CONSOLE_TEXT10"))
								end
							end
						})
					else
