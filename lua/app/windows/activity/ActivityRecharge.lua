-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/ActivityRecharge.lua
...
function ActivityRecharge:setItem()
	...
	for i, v in pairs(ids) do
		...
		if self.activityData.detail.point >= xyd.tables.activityRechargeTable:getPoint(id) then
			is_completed = true
		end
