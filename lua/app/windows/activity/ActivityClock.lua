-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/ActivityClock.lua
			...
			xyd.openWindow("gamble_rewards_window", {
				...
				sureCallback = function()
					if self.isNextRound then
						...
						xyd.alert(xyd.AlertType.CONFIRM, __("ACTIVITY_CLOCK_AWARD_GET"), callback2, __("SURE"), nil, nil, nil, nil, callback2)
