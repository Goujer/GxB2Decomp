-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/ActivityBomb.lua
...
function ActivityBomb:initItems()
	...
	table.sort(self.params, function(a, b)
		...
		if (a.limit > a.buy_times or a.limit < 0) and a.allNum >= a.num then
			ACount = ACount + 10000
		end

		if (b.limit > b.buy_times or b.limit < 0) and b.allNum >= b.num then
			BCount = BCount + 10000
		end
...
function ActivityBombItem:layout()
	...
	if self.params.allNum >= self.params.num then
