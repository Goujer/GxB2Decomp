-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/Activity4BirthdayMusic.lua
...
function Activity4BirthdayMusic:initUIComponent()
	...
	xyd.setUISpriteAsync(self.logoTextImg, nil, "activity_4birthday_musci_logo_" .. xyd.Global.lang, nil, nil, true)
	...
	if not clickShowViewBtnTime then
		...
		if clickShowViewBtnTime < self.activityData:startTime() or clickShowViewBtnTime > self.activityData:getEndTime() then
...
function Activity4BirthdayMusic:sendAward(num)
	...
	if needNum > xyd.models.backpack:getItemNumByID(costArr[1]) then
