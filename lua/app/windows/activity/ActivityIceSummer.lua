-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/ActivityIceSummer.lua
...
function ActivityIceSummer:initUITexture()
	...
	xyd.setUITextureAsync(self.textImg, langImgPath .. "activity_ice_summer_text_" .. xyd.Global.lang, nil, nil)
end
