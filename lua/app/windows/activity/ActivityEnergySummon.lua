-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/ActivityEnergySummon.lua
...
function ActivityEnergySummon:updateInfoRedPoint()
	...
	local InfoRedPoint = self.data:getEnergy() >= self.data:getLimitEnergy() and TodayVisit < self.data:getEndTime() - 1
