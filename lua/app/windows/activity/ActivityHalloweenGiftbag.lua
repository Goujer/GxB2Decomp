-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/ActivityHalloweenGiftbag.lua
...
function ActivityHalloweenGiftbag:initUIComponent()
	xyd.setUISpriteAsync(self.textImg, nil, "activity_halloween_giftbag_text_" .. xyd.Global.lang, nil, nil, true)
	...
	table.sort(self.infos, function(a, b)
		local pointa = xyd.tables.giftBagTable:getBuyLimit(a.table_id) > a.buy_times
		local pointb = xyd.tables.giftBagTable:getBuyLimit(b.table_id) > b.buy_times
...
function ActivityHalloweenGiftbagItem:updateState()
	...
	if self.buyTimes >= self.buyLimit then
