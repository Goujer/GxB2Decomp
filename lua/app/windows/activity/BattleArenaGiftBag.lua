-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/BattleArenaGiftBag.lua
...
function BattleArenaGiftBag:euiComplete()
	...
	xyd.setUISpriteAsync(self.textImg, nil, "battle_arena_giftbag_text01_" .. xyd.Global.lang, nil, nil, true)
...
function BattleArenaGiftBag:setItem()
	...
	for i, v in pairs(ids) do
		...
		if self:getPoint(type) >= xyd.tables.activityArenaTable:getPoint(id) then
			is_completed = true
		end
