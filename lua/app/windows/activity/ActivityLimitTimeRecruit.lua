-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/ActivityLimitTimeRecruit.lua
...
function LimitTimeRecruit:initLayout()
	xyd.setUISpriteAsync(self.titleImg, nil, "activity_time_limit_call_logo_" .. xyd.Global.lang, nil, nil, true)
