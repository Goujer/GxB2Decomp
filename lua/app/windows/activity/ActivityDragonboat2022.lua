-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/ActivityDragonboat2022.lua
...
function ActivityDragonboat2022:initUIComponent()
	xyd.setUISpriteAsync(self.logo, nil, "activity_dragonboat2022_logo_" .. xyd.Global.lang, nil, nil, true)
	...
	xyd.setUISpriteAsync(self.resIcon, nil, xyd.tables.itemTable:getIcon(costItemID), nil, nil)
...
function ActivityDragonboat2022:update()
	...
	if nextPoint <= self.activityData.detail.point2 then
		...
		self.labelProgressNum1.color = Color.New2(3947961599)
		self.labelProgressNum1.effectColor = Color.New2(4294967295)
		...
		self.labelProgressNum2.effectColor = Color.New2(4294967295)
