-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/ActivityBlindBox.lua
...
function ActivityBlindBox:summon(num)
	...
	if num > self.activityData:getTotalRes() then
		xyd.alertTips(__("ACTIVITY_4BIRTHDAY_GAMBLE_TIPS04"))

		return
	end

	if num > xyd.models.backpack:getItemNumByID(xyd.ItemID.BLIND_BOX_TICKET) then
