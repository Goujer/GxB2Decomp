-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/ShenXueGiftBag.lua
...
function ShenXueGiftBag:getUIComponent()
	...
	xyd.setUISpriteAsync(self.textImg, nil, "shenxue_giftbag_text01_" .. tostring(xyd.Global.lang), nil, nil, true)
