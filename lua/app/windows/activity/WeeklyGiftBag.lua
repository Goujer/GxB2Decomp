-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/WeeklyGiftBag.lua
...
function WeeklyGiftBag:setTextures()
	xyd.setUISpriteAsync(self.imgText01, nil, "weekly_giftbag_text01_" .. xyd.Global.lang, nil, nil, true)
	xyd.setUISpriteAsync(self.imgText02, nil, "weekly_giftbag_text02_" .. xyd.Global.lang, nil, nil, true)
	...
	xyd.setUISpriteAsync(self.imgBg, nil, "weekly_bg01", nil, nil, true)
