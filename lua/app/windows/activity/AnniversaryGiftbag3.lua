-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/AnniversaryGiftbag3.lua
...
function AnniversaryGiftbag3:setText()
	...
	xyd.setUISpriteAsync(self.titleImg, nil, "activity_anniversary_giftbag3_title_" .. xyd.Global.lang, nil, nil, true)
...
function AnniversaryGiftbag3:setBtnState()
	...
	if data.limit_times > data.buy_times then
