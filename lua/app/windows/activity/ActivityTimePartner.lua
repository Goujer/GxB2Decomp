-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/ActivityTimePartner.lua
...
function AwardItem:layout()
	...
	local showValue = xyd.checkCondition(self.params.pr >= self.params.needPoint, self.params.needPoint, self.params.pr)
	...
	if self.params.isAwarded == 1 then
		...
		isAwarded = true
	elseif self.params.pr >= self.params.needPoint then
