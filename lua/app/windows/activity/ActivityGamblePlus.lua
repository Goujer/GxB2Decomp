-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/ActivityGamblePlus.lua
...
function ActivityGamblePlus:initItem()
	...
	table.sort(itemParams, function(a, b)
		...
		if itemNum >= a.point and (a.giftBought == 1 and a.awarded == 1 and a.exAwarded == 1 or a.giftBought == 0 and a.awarded == 1) and (itemNum < b.point or b.giftBought == 1 and (b.awarded == 0 or b.exAwarded == 0) or b.giftBought == 0 and b.awarded == 0) then
			return false
		elseif itemNum >= b.point and (b.giftBought == 1 and b.awarded == 1 and b.exAwarded == 1 or b.giftBought == 0 and b.awarded == 1) and (itemNum < a.point or a.giftBought == 1 and (a.awarded == 0 or a.exAwarded == 0) or a.giftBought == 0 and a.awarded == 0) then
			return true
		else
			return a.id < b.id
		end
