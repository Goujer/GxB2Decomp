-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/ActivityHw2022Supply.lua
...
function SupplyItem:setInfo(id)
	...
	for _, info in ipairs(charges) do
		if info.table_id == giftbag_id and info.buy_times >= info.limit_times then
			self.hasBuy = true
		end
	end
