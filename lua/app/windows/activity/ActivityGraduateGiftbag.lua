-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/ActivityGraduateGiftbag.lua
...
function GiftbagItem:layout()
	...
	if self.info.star > detail.score then
		...
		xyd.setUISpriteAsync(self.completedIcon, nil, "agg_icon_uncompleted", nil, nil, true)
		...
		xyd.setUISpriteAsync(self.completedIcon, nil, "agg_icon_completed", nil, nil, true)
