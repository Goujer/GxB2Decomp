-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/MonthlyGiftBag.lua
...
function MonthlyGiftBag:setTextures()
	xyd.setUISpriteAsync(self.imgText01, nil, "monthly_giftbag_text01_" .. xyd.Global.lang, nil, nil, true)
