-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/NewYearSignIn.lua
...
function NewYearSignIn:checkCanSign()
	return math.min(self.total_days_, self.activityData.detail.online_days) > self.activityData.detail.count
end
