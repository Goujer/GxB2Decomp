-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/ActivityWorldBoss.lua
...
function ActivityWorldBossItem:ctor(goItem, params)
	...
	xyd.setUISpriteAsync(self.bgImg, nil, self.bgImgSource, nil, nil, true)
	...
	xyd.setUISpriteAsync(self.titleImg, nil, self.titleImgSource, nil, nil, true)
