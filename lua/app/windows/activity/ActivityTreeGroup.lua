-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/ActivityTreeGroup.lua
...
function ActivityTreeGroup:initUIComponent()
	xyd.setUISpriteAsync(self.textImg_, nil, "activity_tree_group_text_" .. xyd.Global.lang, nil, nil, true)
