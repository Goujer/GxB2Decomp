-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/ActivitySmashEgg.lua
...
function ActivitySmashEgg:initUIComponent()
	xyd.setUISpriteAsync(self.titleImg_, nil, "activity_smash_egg_text_" .. xyd.Global.lang, nil, nil, true)
