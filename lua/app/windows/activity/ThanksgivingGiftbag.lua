-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/ThanksgivingGiftbag.lua
...
function ThanksgivingGiftbag:initUIComponent()
	xyd.setUISpriteAsync(self.textImg, nil, "thanksgiving_giftbag_text_" .. xyd.Global.lang, nil, nil, true)
