-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/ActivityNewbeeFund3.lua
...
function ActActivityNewbeeFund3:initUIComponent()
	...
	xyd.setUISpriteAsync(self.imgText2_, nil, "activity_newbee_fund3_popup_logo_" .. xyd.Global.lang, nil, nil, true)
	...
	xyd.setUISpriteAsync(self.awardIcon, nil, "icon_" .. xyd.ItemID.CRYSTAL, nil, nil)
