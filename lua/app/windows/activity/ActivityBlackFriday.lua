-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/ActivityBlackFriday.lua
...
function ActivityBlackFriday:initTexture()
	xyd.setUISpriteAsync(self.textImg, nil, "activity_black_new_logo_" .. xyd.Global.lang, nil, nil, true)
end
...
function ActivityBlackFriday:initItems()
	...
	local midIconNum, bottomIconNum = 0, 0
