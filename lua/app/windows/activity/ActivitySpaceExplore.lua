-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/ActivitySpaceExplore.lua
...
function ActivitySpaceExplore:initUIComponent()
	xyd.setUISpriteAsync(self.logoTextImg, nil, "activity_space_explore_text_" .. xyd.Global.lang, nil, nil)
