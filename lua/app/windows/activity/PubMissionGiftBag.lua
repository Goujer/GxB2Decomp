-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/PubMissionGiftBag.lua
...
function PubMissionGiftBag:setItem()
	...
	for i, v in pairs(ids) do
		...
		if self:getPoint(id) >= xyd.tables.activityPubMissionTable:getCompleteValue(id) then
			is_completed = true
		end
