-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/LimitFiveStarGiftBag.lua
...
function LimitFiveStarGiftBag:initUIComponent()
	xyd.setUISpriteAsync(self.imgText_, nil, "limit_five_star_giftbag_text01_" .. xyd.Global.lang, nil, nil, true)
