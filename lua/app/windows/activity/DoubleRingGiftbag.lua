-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/DoubleRingGiftbag.lua
...
function DoubleRingGiftbag:updateStatus()
	if self.activityData.detail.charges[1].buy_times >= self.buy_limit_count_ then
