-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/TuringMissionWindow.lua
...
function TuringMissionWindow:initUI()
	...
	xyd.setUISpriteAsync(self.textImg, nil, "activity_hw2022_mission_logo_" .. xyd.Global.lang, nil, nil, true)
	self:setText()
