-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/ActivitySevenDay.lua
...
function ActivitySevenDay:initUIComponent()
	xyd.setUISpriteAsync(self.desImg, nil, "activity_sevenday_text01_" .. xyd.Global.lang, nil, nil, true)
