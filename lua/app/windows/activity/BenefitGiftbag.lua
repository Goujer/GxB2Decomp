-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/BenefitGiftbag.lua
...
function BenefitGiftbag:initUIComponent()
	xyd.setUISpriteAsync(self.textImg, nil, "benefit_giftbag03_text01_" .. xyd.Global.lang, nil, nil, true)
end
