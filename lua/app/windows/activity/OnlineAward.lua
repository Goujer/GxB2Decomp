-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/OnlineAward.lua
...
function OnlineAward:initUIComponent()
	xyd.setUISpriteAsync(self.countDownTextImg, nil, "online_award_countdown_" .. xyd.Global.lang, nil, nil, true)
...
function OnlineAwardItemIcon:canGetAward()
	if self.curTime >= self.sumTime then
		self:addEffect()
