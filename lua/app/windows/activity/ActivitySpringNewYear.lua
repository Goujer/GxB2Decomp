-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/ActivitySpringNewYear.lua
...
function ActivitySpringNewYear:updateProgress()
	...
	for i = 1, 6 do
		...
		if imgPoint <= self.activityData.detail.point then
			...
			imgName = i <= 2 and "activity_jigsaw_icon01_1" or i <= 4 and "activity_jigsaw_icon02_1" or "activity_jigsaw_open_icon"

			xyd.setUISpriteAsync(self["boxImg" .. i], nil, imgName, nil, nil)
		else
			local imgName = ""

			imgName = i <= 2 and "activity_jigsaw_icon01_0" or i <= 4 and "activity_jigsaw_icon02_0" or "trial_icon04"
