-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/NewSummonSpecialHeroGift.lua
...
function NewSummonSpecialHeroGift:setItem()
	...
	for i = 1, #ids do
		local id = ids[i]
		local isCompleted = self.activityData.detail.point >= ActivityGachaPartnerAwardTable:getLevel(id)
		local item = {
			id = id,
