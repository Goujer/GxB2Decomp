-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/ActivityNewbee10Gacha.lua
...
function ActivityNewbee10Gacha:layout()
	xyd.setUISpriteAsync(self.titleImg_, nil, "newbee_10gacha_logo_" .. xyd.Global.lang, nil, nil, true)
