-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/ActivityDressOpeningCeremony.lua
...
function ActivityDressOpeningCeremony:layout()
	xyd.setUISpriteAsync(self.imgTitle, nil, "dress_opening_ceremony_text_" .. tostring(xyd.Global.lang), nil, nil, true)
