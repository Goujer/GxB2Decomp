-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/SummonGiftBag.lua
...
function SummonGiftBag:setItems()
	...
	for i = 1, #ids do
		local id = ids[i]
		local isCompleted = self.activityData.detail.point >= xyd.tables.activityGachaTable:getPoint(id)
		local item = {
			id = id,
