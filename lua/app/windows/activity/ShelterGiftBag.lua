-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/ShelterGiftBag.lua
...
function ShelterGiftBag:layout()
	...
	if updateTime > xyd.getServerTime() then
		...
		params.duration = updateTime - xyd.getServerTime()
...
function ShelterGiftBag:onPageChange(needCheck, changeNum)
	...
	if changeNum + self.cur_page > self.max_page then
