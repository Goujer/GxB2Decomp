-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/ActivityCollectCoralBranch.lua
...
function ActivityCollectCoralBranchItem:initItem(itemdata)
	...
	for _, reward in pairs(itemdata.awards) do
		...
		if itemdata.curPoint - math.floor(itemdata.curPoint / 300) * 300 >= itemdata.point then
			icon:setChoose(true)
		end
	end
end
