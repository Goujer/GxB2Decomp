-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/SummonWelfare.lua
...
function SummonWelfare:layout()
	...
	xyd.setUISpriteAsync(self.titleImg, nil, "summon_welfare_text01_" .. xyd.Global.lang, nil, nil, true)
