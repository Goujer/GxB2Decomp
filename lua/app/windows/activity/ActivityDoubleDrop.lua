-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/ActivityDoubleDrop.lua
...
function ActivityDoubleDrop:setTexture()
	xyd.setUISpriteAsync(self.imgTitle, nil, "activity_double_drop_logo_" .. xyd.Global.lang, nil, nil, true)
	xyd.setUISpriteAsync(self.imgLabel, nil, "activity_double_drop_up_" .. xyd.Global.lang, nil, nil, true)
end
