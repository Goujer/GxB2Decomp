-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/ActivityLimitGachaAward.lua
...
function ActivityLimitGachaAward:refresh()
	...
	elseif self.curIndex > self:getMaxIndex() then
