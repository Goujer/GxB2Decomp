-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/ActivityVampireTask.lua
...
function TaskItem:initUI()
	...
	UIEventListener.Get(self.bg.gameObject).onClick = handler(self, function()
		xyd.goWay(xyd.tables.activityVampireTaskTable:getGetway(self.id), nil, nil, function()
			xyd.models.activity:reqActivityByID(xyd.ActivityID.ACTIVITY_VAMPIRE_TASK)
		end)
	end)
end
