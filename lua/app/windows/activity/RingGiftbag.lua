-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/RingGiftbag.lua
...
function RingGiftbag:initUIComponent()
	...
	xyd.setUISpriteAsync(self.textImg, nil, "ring_giftbag_text01_" .. xyd.Global.lang, nil, nil, true)
...
function RingGiftbag:returnCommonScreen()
	...
	local ____TS_obj, ____TS_index = self.textImg, "y"
