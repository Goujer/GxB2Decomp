-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/ActivityGiftBagOptional.lua
...
function ActivityGiftBagOptional:initUIComponent()
	xyd.setUISpriteAsync(self.imgText_, nil, "activity_giftbag_optional_text_" .. xyd.Global.lang, nil, nil, true)

	self.tipsLabel_.text = __("ACTIVITY_GIFTBAG_OPTIONAL_TEXT01")

	if self.activityData:getUpdateTime() > xyd.getServerTime() then
		if xyd.Global.lang == "fr_fr" then
			self.timeLabel_.color = Color.New2(4294901503)
			self.endLabel_.color = Color.New2(2667547647)
