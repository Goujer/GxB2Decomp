-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/FollowingGiftBag.lua
...
function FollowingGiftBag:initUIComponent()
	...
	xyd.setUISpriteAsync(self.imgData_, nil, "following_giftbag_award_" .. xyd.Global.lang, nil, nil, true)
	xyd.setUISpriteAsync(self.imgTitle_, nil, "following_giftbag_title_" .. xyd.Global.lang, nil, nil, true)
