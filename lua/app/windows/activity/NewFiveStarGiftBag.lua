-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/NewFiveStarGiftBag.lua
...
function NewFiveStarGiftBag:initUIComponent()
	...
	xyd.setUISpriteAsync(self.imgText01, nil, "five_star_gift_text01_" .. tostring(xyd.Global.lang), nil, nil, true)
	...
	if xyd.Global.lang == "en_en" then
		...
		xyd.setUISpriteAsync(self.imgText02, nil, "five_star_gift_text02_" .. tostring(xyd.Global.lang), nil, nil, true)
	end
...
function NewFiveStarGiftBag:onRecharge(evt)
	...
	if self.data.buy_times >= self.limit_times then
		self:setBtnState(false)
	end
