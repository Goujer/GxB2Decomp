-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/ActivityPromotionTest.lua
...
function ActivityPromotionTest:initUIComponent()
	...
	for i = 1, #self.partnerIndexArr do
		...
		xyd.setUISpriteAsync(self["partnerImg" .. i], nil, "activity_promotion_test_zj_" .. partnerIndex, nil, nil, true)
