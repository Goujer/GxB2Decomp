-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/NewPushGiftBag.lua
...
function NewPushGiftBag:initContent()
	...
	elseif activityID == xyd.ActivityID.GRADE_STONE_PUSH_GIFTBAG then
		...
		self.expLabel_.effectColor = Color.New2(4294967295)
		self.limitLabel_.color = Color.New2(3762979583)
		self.limitLabel_.effectStyle = UILabel.Effect.Outline8
		self.limitLabel_.effectColor = Color.New2(4294967295)
	...
	elseif activityID == xyd.ActivityID.ACADEMY_ASSESSMENT_PUSH_GIFTBAG then
		...
		self.timeLabel_.color = Color.New2(4294967295)
		self.timeLabel_.effectStyle = UILabel.Effect.Outline8
		self.endLabel_.color = Color.New2(4294967295)
		self.endLabel_.effectStyle = UILabel.Effect.Outline8
		self.expLabel_.color = Color.New2(964090879)
		...
		if self.assessment_type == 1 then
			...
			self.timeLabel_.effectColor = Color.New2(3545533183)
			self.endLabel_.effectColor = Color.New2(3545533183)
		...
		elseif self.assessment_type == 3 then
			...
			self.timeLabel_.effectColor = Color.New2(3107468799)
			self.endLabel_.effectColor = Color.New2(3107468799)
		...
		elseif self.assessment_type == 6 then
			...
			self.timeLabel_.effectColor = Color.New2(3479188735)
			self.endLabel_.effectColor = Color.New2(3479188735)
		end
