-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/ActivityWelfareSale.lua
...
function ActivityWelfareSale:initUIComponent()
	xyd.setUISpriteAsync(self.textImg_, nil, "welfare_sale_text01_" .. xyd.Global.lang, nil, nil, true)
