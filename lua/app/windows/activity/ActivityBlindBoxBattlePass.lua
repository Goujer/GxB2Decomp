-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/ActivityBlindBoxBattlePass.lua
...
function FundItemIcon:setInfo(params)
	...
	if params.baseFundItemState then
		...
		xyd.setUISpriteAsync(self.imgGetSprite, "activity_blind_box_battlepass_web", "icon_dg_fl", nil, nil, true)
		xyd.setUISpriteAsync(self.imgMaskSprite, "activity_blind_box_battlepass_web", "mb_fl", nil, nil, true)
	...
	if params.advFundItemState then
		xyd.setUISpriteAsync(self.imgGetSprite, "activity_blind_box_battlepass_web", "icon_dg_cz", nil, nil, true)
		xyd.setUISpriteAsync(self.imgMaskSprite, "activity_blind_box_battlepass_web", "mb_cz", nil, nil, true)
		xyd.setUISpriteAsync(self.imgLockSprite, "activity_blind_box_battlepass_web", "icon_s_cz", nil, nil, true)
	...
	if params.superFundItemState then
		xyd.setUISpriteAsync(self.imgGetSprite, "activity_blind_box_battlepass_web", "icon_dg_hh", nil, nil, true)
		xyd.setUISpriteAsync(self.imgMaskSprite, "activity_blind_box_battlepass_web", "mb_hh", nil, nil, true)
		xyd.setUISpriteAsync(self.imgLockSprite, "activity_blind_box_battlepass_web", "icon_s_hh", nil, nil, true)
...
function ActivityBlindBoxBattlePass:setTexture()
	xyd.setUISpriteAsync(self.giftBagGroup1Title, nil, "activity_blind_box_battlepass_logo_czlb_" .. xyd.Global.lang, nil, nil, true)
	xyd.setUISpriteAsync(self.giftBagGroup2Title, nil, "activity_blind_box_battlepass_logo_hhlb_" .. xyd.Global.lang, nil, nil, true)
end
...
function FundItem:update(_, info)
	...
	if self.parent.dayNow >= self.info.dayNeed and self.info.isBaseAwarded == false then
	...
	elseif self.info.giftBag1Buy == true and self.parent.dayNow >= self.info.dayNeed and self.info.isAdvanceAwarded == false then
	...
	elseif self.info.giftBag1Buy == false and self.parent.dayNow >= self.info.dayNeed then
	...
	elseif self.info.giftBag2Buy == true and self.parent.dayNow >= self.info.dayNeed and self.info.isSuperAwarded == false then
	...
	elseif self.info.giftBag2Buy == false and self.parent.dayNow >= self.info.dayNeed then
...
function FundItem:setFundListInfo()
	...
	if self.parent.dayNow < self.info.dayNeed then
		xyd.setUISpriteAsync(self.labelDayBg, "activity_blind_box_battlepass_web", "bg_dl_2", nil, nil, true)
	else
		xyd.setUISpriteAsync(self.labelDayBg, "activity_blind_box_battlepass_web", "bg_dl_1", nil, nil, true)
	end
