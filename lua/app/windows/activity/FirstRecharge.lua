-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/FirstRecharge.lua
...
function FirstRecharge:layout()
	xyd.setUISpriteAsync(self.imgText01, nil, "first_recharge_text01_" .. xyd.Global.lang, nil, nil, true)
	self:setIcon()
