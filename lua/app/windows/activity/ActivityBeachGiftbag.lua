-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/ActivityBeachGiftbag.lua
...
function ActivityBeachGiftbag:initUIComponent()
	xyd.setUISpriteAsync(self.textImg_, nil, "activity_beach_giftbag_logo_" .. xyd.Global.lang, nil, nil, true)
...
function ActivityBeachGiftbag:updateSpecialItem()
	...
	xyd.setUISpriteAsync(self.specialItemIcon_, nil, "icon_358", nil, nil, true)
