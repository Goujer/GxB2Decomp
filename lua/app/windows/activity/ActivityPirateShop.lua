-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/ActivityPirateShop.lua
...
function ActivityPirateShop:getUIComponent()
	...
	xyd.setUISpriteAsync(self.logoImg_, nil, "activity_pirate_shop_logo_" .. xyd.Global.lang, nil, nil, true)
...
function ActivityPirateShop:updateNav()
	if self.curSelect_ == 1 then
		...
		self.nav1Label_.color = Color.New2(4294967295)
		self.nav2Label_.color = Color.New2(3924024575)
		self.nav1Label_.effectColor = Color.New2(3467345407)
		self.nav2Label_.effectColor = Color.New2(2573749759)
	else
		self.nav2Select_:SetActive(true)
		self.nav1Select_:SetActive(false)

		self.nav2Label_.color = Color.New2(4294967295)
		self.nav1Label_.color = Color.New2(3924024575)
		self.nav2Label_.effectColor = Color.New2(3467345407)
		self.nav1Label_.effectColor = Color.New2(2573749759)
	end
end
...
function ActivityPirateShop:updateMissionInfo()
	...
	for i = 1, #missions do
		...
		if not self.missionItems_[mission_id] then
			...
			xyd.setUISpriteAsync(missionImg, nil, "icon_" .. iconImg, nil, nil, true)
