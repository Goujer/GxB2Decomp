-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/ActivityTuringMission4.lua
...
function ActivityTuringMission4:initUI()
	...
	xyd.setUISpriteAsync(self.textImg, nil, "activity_turing_mission4_logo_" .. xyd.Global.lang, nil, nil, true)
	self:setText()
