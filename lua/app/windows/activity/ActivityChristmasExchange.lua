-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/ActivityChristmasExchange.lua
...
function ActivityChristmasExchange:clickbtnExchange()
	...
	xyd.alertYesNo(__("ACTIVITY_SOCKS_CHANGE_TEXT05", self.labelBtnExchange.text, name1, name2), callback, __("YES"), false, nil, nil, nil, nil, nil, nil)
end
