-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/ActivityTowerEmergency.lua
...
function ActivityTowerEmergency:layout()
	...
	xyd.setUISpriteAsync(self.titleImg, nil, "tower_emergency_text_" .. xyd.Global.lang, nil, nil, true)
