-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/AllStarsPrayGiftbag.lua
...
function AllStarsPrayGiftbag:initUIComponent()
	xyd.setUISpriteAsync(self.textImg, nil, "all_stars_pray_giftbag_text_" .. xyd.Global.lang, nil, nil, true)
	...
	table.sort(self.infos, function(a, b)
		local pointa = a.limit_times > a.buy_times
		local pointb = b.limit_times > b.buy_times
