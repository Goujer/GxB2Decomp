-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/ActivityValentine.lua
...
function ActivityValentine:initUIComponent()
	...
	xyd.setUISpriteAsync(self.imgText_, nil, "activity_valentine_text_" .. xyd.Global.lang, nil, nil, true)
...
function ActivityValentine:updateAwards()
	...
	for i = 1, 5 do
		...
		if award < 1 and i < 5 then
			xyd.setUISpriteAsync(awardIcon, nil, "activity_valentine_award_icon1", nil, nil, true)
		elseif award == 1 and i < 5 then
			xyd.setUISpriteAsync(awardIcon, nil, "activity_valentine_award_icon2", nil, nil, true)
			awardIcon:Y(-8)
		elseif award < 1 and i == 5 then
			xyd.setUISpriteAsync(awardIcon, nil, "activity_valentine_award_icon3", nil, nil, true)
		elseif award == 1 and i == 5 then
			xyd.setUISpriteAsync(awardIcon, nil, "activity_valentine_award_icon4", nil, nil, true)
			awardIcon:Y(-8)
		end
