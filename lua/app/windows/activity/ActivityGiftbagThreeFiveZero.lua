-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/ActivityGiftbagThreeFiveZero.lua
...
function ActivityGiftbagThreeFiveZero:initUIComponent()
	xyd.setUISpriteAsync(self.textImg, nil, "activity_giftbag_350_logo_" .. xyd.Global.lang, nil, nil, true)
