-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/ActivityEnconterStory.lua
...
function ActivityEnconterStory:updateMissionState(id)
	...
	for i = startNum, endNum do
		...
		if xyd.models.backpack:getItemNumByID(cost[1]) >= cost[2] and self.activityData.detail.plots[i] == 0 then
		...
		xyd.setUISpriteAsync(self["missionType" .. i], nil, "activity_enconter_story_icon" .. type_, nil, nil, true)
