-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/Activity3BirthdayVipWindow.lua
...
function Activity3BirthdayVipWindow:initUIComponent()
	xyd.setUISpriteAsync(self.textImg_, nil, "activity_3birthday_vip_text_" .. xyd.Global.lang, nil, nil, true)
...
function Activity3BirthdayVipItem:updateInfo()
	...
	elseif self.curVipLev >= self.targetVipLev then
