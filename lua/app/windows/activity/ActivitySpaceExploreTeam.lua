-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/ActivitySpaceExploreTeam.lua
...
function ActivitySpaceExploreTeam:onSummon(num)
	if num > xyd.models.backpack:getItemNumByID(xyd.ItemID.ACTIVITY_SPACE_EXPLORE_SUMMON_SCROLL) then
