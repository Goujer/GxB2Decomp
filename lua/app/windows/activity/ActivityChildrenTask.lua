-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/ActivityChildrenTask.lua
...
function ActivityChildrenTaskItem:setInfo(data)
	...
	if self.data_.is_completed >= self.data_.limit then
		...
		self.completeNum.color = Color.New2(3525795839)
