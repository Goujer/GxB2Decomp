-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/NewPartnerWarmupGiftbag.lua
...
function NewPartnerWarmupGiftbag:initUIComponent()
	xyd.setUISpriteAsync(self.imgLogo, nil, "new_partner_warmup_giftbag_text_" .. xyd.Global.lang, nil, nil, true)
