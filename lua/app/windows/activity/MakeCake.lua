-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/MakeCake.lua
...
function MakeCake:layout()
	...
	xyd.setUITextureAsync(self.titleImg, "Textures/activity_text_web/activity_make_cake_caffe_" .. xyd.Global.lang, nil, nil)
		...
		if self.items_[i].lock_ then
			...
			for j = 1, 3 do
				...
				if info ~= nil then
					...
					if detail["times_" .. self.items_[i].id_][j] >= info.limit then
						useRed = false
