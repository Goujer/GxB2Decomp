-- chunkname: @../../../Product/Bundles/Android/src/app/windows/activity/ActivityJackpotLottery.lua
...
function ActivityJackpotLottery:updateBtnShow()
	...
	self.upLeftBtn:NodeByName("redPoint").gameObject:SetActive(xyd.models.backpack:getItemNumByID(self.upCostOne[1]) >= self.upCostOne[2])
	...
	self.downLeftBtn:NodeByName("redPoint").gameObject:SetActive(xyd.models.backpack:getItemNumByID(self.downCostOne[1]) >= self.downCostOne[2])
...
function IconItem:initUI()
	...
	if self.curNum == 0 then
		...
		self.hasNumLabel.color = Color.New2(4294967295)
	end
end
