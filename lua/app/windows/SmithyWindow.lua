-- chunkname: @../../../Product/Bundles/Android/src/app/windows/SmithyWindow.lua
...
function SmithyWindow:setItemIcon(itemID, index)
	...
	itemIcon:setRedMark(selfNum >= needEquip[2])
end
...
function SmithyWindow:composeItem()
	if self.curNum_ > self.maxComposeNum_ then
...
function SmithyWindow:initSelectNum(maxNum, prices)
	...
	local function callback(num)
		...
		if mana_ < num * price then
			self.labelCost_.color = Color.New2(4278190335)
		else
