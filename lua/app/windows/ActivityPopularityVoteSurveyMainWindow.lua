-- chunkname: @../../../Product/Bundles/Android/src/app/windows/ActivityPopularityVoteSurveyMainWindow.lua
...
function ActivityPopularityVoteSurveyMainWindow:initUIComponent()
	...
	for i = 1, 4 do
		xyd.setUISpriteAsync(self["imgSkin" .. i], nil, skinURL[i], nil, nil, true)
