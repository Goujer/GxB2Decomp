-- chunkname: @../../../Product/Bundles/Android/src/app/windows/ArcticExpeditionMissionWindow.lua
...
function ArcticMissionItem1:setInfo(params)
	...
	if params.value >= params.complete_value then
...
function ArcticMissionItem2:setInfo(params)
	...
	if params.is_awarded < params.limit_time and params.is_completeds > params.is_awarded and params.is_completeds > 0 then
		self.progressBar_.value = 1
		self.progressLabel_.text = params.complete_value .. "/" .. params.complete_value
	elseif params.is_awarded >= params.limit_time then
		self.progressBar_.value = 1
		self.progressLabel_.text = params.complete_value .. "/" .. params.complete_value
	else
	...
	if params.is_awarded and params.is_awarded >= params.limit_time then
		xyd.setEnabled(self.btnAward_, false)
