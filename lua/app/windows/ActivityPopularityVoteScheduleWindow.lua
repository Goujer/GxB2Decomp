-- chunkname: @../../../Product/Bundles/Android/src/app/windows/ActivityPopularityVoteScheduleWindow.lua
...
function ScheduleItem:initUI()
	...
	local periodList = xyd.split(xyd.tables.miscTable:getVal("activity_popularity_vote_stagetime"), "|", true)
	local startTime, endTime, childPeriodsList
