-- chunkname: @../../../Product/Bundles/Android/src/app/windows/GuildWarFormationWindow.lua
...
function GuildWarFormationWindow:initWindow()
	...
	for i = 1, 6 do
		...
		heroIcon.root = contentTrans:NodeByName("group/groupPartner/HeroIcon" .. i).gameObject
		heroIcon.cover = contentTrans:NodeByName("group/groupPartner/HeroIcon" .. i .. "/cover").gameObject
