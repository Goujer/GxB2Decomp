-- chunkname: @../../../Product/Bundles/Android/src/app/windows/GuildCompetitionMainWindow.lua
...
function GuildCompetitionMainWindow:initUIComponent()
	...
	xyd.setUISpriteAsync(self.scoreConTextImg, nil, "guild_competition_rank_" .. xyd.Global.lang, nil, nil)
	self:initEffect()
	self:initRecordBtn()
	self:initTopGroup()
	self:registerEvent()
...
function GuildCompetitionMainWindow:showRecordBtnClick()
	...
	self.sequence:AppendCallback(function()
		...
		if self.showRecordIsSmall then
			...
			xyd.setUISpriteAsync(self.showMoreRecordBtn, nil, "guild_competition_down", nil, nil)
		else
			xyd.setUISpriteAsync(self.showMoreRecordBtn, nil, "guild_competition_up", nil, nil)
		end
