-- chunkname: @../../../Product/Bundles/Android/src/app/windows/ActivityRechargeLotteryBoxDetailWindow.lua
...
function ActivityRechargeLotteryBoxDetailWindow:initUIComponent()
	xyd.setUISpriteAsync(self.imgBox, nil, "activity_recharge_lottery_" .. self.boxName, nil, nil, true)
	xyd.setUISpriteAsync(self.imgText, nil, "activity_recharge_lottery_" .. self.boxName .. "_" .. xyd.Global.lang, nil, nil, true)
