-- chunkname: @../../../Product/Bundles/Android/src/app/windows/DressShowTotalAwardWindow.lua
...
function DressShowTotalAwardWindow:initFourGroup()
	for i = 1, 4 do
		...
		if not score or score < 0 then
			...
			if level == 6 then
				labelRank.text = "S"
				labelRank.color = Color.New2(2874471423)
			elseif level == 5 then
				labelRank.text = "A"
				labelRank.color = Color.New2(4268112895)
			elseif level == 4 then
				labelRank.text = "B"
