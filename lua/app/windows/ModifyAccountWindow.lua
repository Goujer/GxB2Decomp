-- chunkname: @../../../Product/Bundles/Android/src/app/windows/ModifyAccountWindow.lua
...
function ModifyAccountWindow:layout()
	local btnOtherlabel, labelTitletext, btnFacebooklabel, btnGooglelabel, btnLinelabel, btnGameCenterlabel, btnApplelabel
