-- chunkname: @../../../Product/Bundles/Android/src/app/windows/BattleFailWindow.lua
...
function BattleFailWindow:initLayout()
	...
	elseif self.battleType == xyd.BattleType.ACTIVITY_SPACE_EXPLORE then
		...
		xyd.setUISpriteAsync(tmp_btn_uiSprite, nil, "activity_space_explore_btn_sb_dy", nil, nil, true)
		...
		xyd.setUISpriteAsync(left_tmp_btn_uiSprite, nil, "activity_space_explore_btn_sb_bg", nil, nil, true)
		...
		xyd.setUISpriteAsync(right_tmp_btn_uiSprite, nil, "activity_space_explore_btn_sb_zj", nil, nil, true)
	...
	if not xyd.GuideController.get():isGuideComplete() then
		...
		UIEventListener.Get(leftBtn.gameObject).onClick = handler(self, function()
			xyd.WindowManager.get():openWindow("battle_win_window", {
				...
				dogIsShowItems = self.params_.dogLevel > xyd.models.selfPlayer:getDogMiniPassLevel()
			})
