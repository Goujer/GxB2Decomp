-- chunkname: @../../../Product/Bundles/Android/src/app/windows/ActivitySportsWindow.lua
...
function ActivitySportsWindow:layout()
	...
	xyd.setUISpriteAsync(self.flag_uiSprite, nil, "sports_group_" .. tostring(self.activityData.detail.arena_info.group), nil, nil)
	self:updateScore()
...
function ActivitySportsWindow:setTimeShow()
	if xyd.getServerTime() > self.activityData:getStateEndTime() then
