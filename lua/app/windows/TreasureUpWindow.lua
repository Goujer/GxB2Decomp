-- chunkname: @../../../Product/Bundles/Android/src/app/windows/TreasureUpWindow.lua
...
function TreasureUpWindow:updateTextColor()
	...
	if magic_dust_num > bp:getItemNumByID(xyd.ItemID.MAGIC_DUST) then
...
function TreasureUpWindow:checkCrystal()
	...
	if bp:getItemNumByID(xyd.ItemID.MANA) < cost[xyd.ItemID.MANA] then
		...
		return
	elseif magic_dust_num > bp:getItemNumByID(xyd.ItemID.MAGIC_DUST) then
