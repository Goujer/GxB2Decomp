-- chunkname: @../../../Product/Bundles/Android/src/app/windows/ActivityResidentReturnSupportAwardWindow.lua

local BaseWindow = import(".BaseWindow")
local ActivityResidentReturnSupportAwardWindow = class("ActivityResidentReturnSupportAwardWindow", BaseWindow)
local ActivityResidentReturnRewardTable = xyd.tables.activityResidentReturnRewardTable

function ActivityResidentReturnSupportAwardWindow:ctor(name, params)
	BaseWindow.ctor(self, name, params)
end

function ActivityResidentReturnSupportAwardWindow:initWindow()
	ActivityResidentReturnSupportAwardWindow.super.initWindow(self)
	self:getUIComponent()
	self:initUIComponent()
	self:register()
end

function ActivityResidentReturnSupportAwardWindow:getUIComponent()
...
function ActivityResidentReturnSupportAwardWindow:initUIComponent()
	...
	for i = 1, #ids do
		local extraAwards = ActivityResidentReturnRewardTable:getExtraAwards(i)
		...
		local baseAwards = ActivityResidentReturnRewardTable:getBaseAwards(i)
...
function ActivityResidentReturnSupportAwardWindow:register()
	ActivityResidentReturnSupportAwardWindow.super.register(self)
end

return ActivityResidentReturnSupportAwardWindow
