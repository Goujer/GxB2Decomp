-- chunkname: @../../../Product/Bundles/Android/src/app/windows/ActivityHalloweenTrickPreviewWindow.lua
...
function ActivityHalloweenTrickPreviewWindow:layout()
	...
	elseif self.params.windowTpye == WINDOW_TYPE.GOLDFISH then
		self.labelTitle.text = __("ACTIVITY_TRICKORTREAT_TEXT03")
		...
		table.sort(specialArr, function(a, b)
			return weights[a.weightIndex] > weights[b.weightIndex]
		end)
