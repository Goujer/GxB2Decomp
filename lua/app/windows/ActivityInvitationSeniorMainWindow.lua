-- chunkname: @../../../Product/Bundles/Android/src/app/windows/ActivityInvitationSeniorMainWindow.lua
...
function ActivityInvitationSeniorMainWindow:layout()
	...
	if self.curState == xyd.ActivityInvitationSeniorState.OLD then
		...
		xyd.setUISpriteAsync(self.nameImg, nil, "invitation_senior_text_logo_yq_" .. xyd.Global.lang, nil, nil, true)
	...
	elseif self.curState == xyd.ActivityInvitationSeniorState.NEW then
		...
		xyd.setUISpriteAsync(self.nameImg, nil, "invitation_senior_text_logo_rx_" .. xyd.Global.lang, nil, nil, true)
