-- chunkname: @../../../Product/Bundles/Android/src/app/windows/ArenaTeamRecordDetailWindow.lua
...
function ArenaTeamRecordDetailItem:setInfo(params, matchNum, isAttack)
	...
	petIDA = (not petA or not petA.pet_id) and 0 or petA.pet_id
	petIDB = (not petB or not petB.pet_id) and 0 or petB.pet_id
