-- chunkname: @../../../Product/Bundles/Android/src/app/windows/SkinDetailWindow.lua
...
function SkinDetailWindow:setSkinBtn()
	...
	if xyd.tables.shopSkinTable:itemCanBuy(currentSkinID) == false then
		...
		xyd.setUISpriteAsync(self.btnBuy_imgCost, nil, tostring(xyd.tables.itemTable:getIcon(cost[1])), nil, nil)
