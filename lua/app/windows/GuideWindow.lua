-- chunkname: @../../../Product/Bundles/Android/src/app/windows/GuideWindow.lua
...
function GuideWindow:resetWnd()
	...
	self.maskImage_.color = Color.New2(4294967043)
...
function GuideWindow:layout()
	...
	local function callback()
		if GuideTable:isTransition(self.guideID) then
			self.maskImage_.color = Color.New2(4294967218)
		end
	...
	if self.obj then
		...
		if handType[1] == 1 then
			local function moveAction()
				...
				self.imgHand_.color = Color.New2(4294967295)
...
function GuideWindow:initDialog()
	...
	if desc and desc ~= "" then
		...
		local label, imgDialogBg, anchorNum
...
function GuideWindow:iosTestChangeUI()
	self.labelDesc1.color = Color.New2(4294967295)
	self.labelDesc2.color = Color.New2(4294967295)
