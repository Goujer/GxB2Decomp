-- chunkname: @../../../Product/Bundles/Android/src/app/windows/ExploreAdventurePrepareWindow.lua
...
function ExploreAdventurePrepareWindow:prepareBattle()
	local fightParams = {
		...
		showSkip = self.lv >= xyd.tables.miscTable:getNumber("travel_quick_limit", "value"),
