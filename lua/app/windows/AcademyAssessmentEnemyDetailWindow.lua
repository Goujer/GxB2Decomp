-- chunkname: @../../../Product/Bundles/Android/src/app/windows/AcademyAssessmentEnemyDetailWindow.lua
...
function AcademyAssessmentEnemyDetailWindow:setLayout()
	...
	if self.battleType and self.battleType > 0 then
		xyd.setUISpriteAsync(self.bgImg, nil, "shrine_enemy_bg", nil, nil, true)
		...
		xyd.setUISpriteAsync(self.bgImg, nil, "tower_detailbg", nil, nil, true)
