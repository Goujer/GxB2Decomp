-- chunkname: @../../../Product/Bundles/Android/src/app/windows/ActivitySimulationGachaGiftbagWindow.lua
...
function ActivitySimulationGachaGiftbagWindow:initUIComponent()
	xyd.setUISpriteAsync(self.imgText, nil, "activity_simulation_gacha_giftbag_text_" .. xyd.Global.lang, nil, nil, true)
