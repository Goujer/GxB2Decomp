-- chunkname: @../../../Product/Bundles/Android/src/app/windows/EntranceTestPromotionWindow.lua
...
function EntranceTestPromotionWindow:layout()
	...
	xyd.setUISpriteAsync(self.levelImg_, nil, "entrance_test_level_" .. level, nil, nil, true)
