-- chunkname: @../../../Product/Bundles/Android/src/app/windows/CollectionFaceWindow.lua
...
function CollectionFaceWindow:updateBtns()
	for i = 1, self.btnNum do
		if i == self.sortType then
			...
			self["filterLabel" .. tostring(i) .. "_"].color = Color.New2(4294967295)
			...
			self["filterLabel" .. tostring(i) .. "_"].effectColor = Color.New2(4294967295)
		end
	end
end
