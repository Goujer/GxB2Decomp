-- chunkname: @../../../Product/Bundles/Android/src/app/windows/ChoosePartnerWindow.lua
...
function ChoosePartnerWindow:addPartnerToContainer(partner)
	...
	function params.callback(icon)
		...
		if not choose and (self.type_ == "ACTIVITY_PROMOTION_LADDER" or self.type_ == "ACTIVITY_FREE_REVERGE" or self.type_ == "ACTIVITY_FOOD_CONSUME" or self.type_ == "ACTIVITY_PROMOTION_LADDER2") and #self.selected >= self.needNum then
			self:clearChoose()
		end
