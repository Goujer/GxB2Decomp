-- chunkname: @../../../Product/Bundles/Android/src/app/windows/ActivityLegendarySkinShopWindow.lua
...
function ActivityEquipLevelUpAwardItem:updateInfo()
	...
	if self.data[2] >= xyd.tables.activityLengarySkinShopTable:getLimit(self.data[1]) then
