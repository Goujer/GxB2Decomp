-- chunkname: @../../../Product/Bundles/Android/src/app/windows/MidasWindow.lua
...
function MidasWindow:setBtnState()
	if self.is_free_award and self.is_free_award > 0 then
		...
		self.btnBuy1_label.effectColor = Color.New2(4294967295)
		...
		self.btnBuy1_label.color = Color.New2(4294967295)
	...
	if self.buy_times and self.buy_times >= xyd.tables.vipTable:getMidasTimes(xyd.models.backpack:getVipLev()) then
		...
		self.btnBuy2_label.effectColor = Color.New2(4294967295)
		...
		self.btnBuy2_label.color = Color.New2(4294967295)
