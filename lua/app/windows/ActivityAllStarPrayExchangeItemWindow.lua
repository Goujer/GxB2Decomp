-- chunkname: @../../../Product/Bundles/Android/src/app/windows/ActivityAllStarPrayExchangeItemWindow.lua
...
function ActivityAllStarPrayExchangeItemWindow:createChildren()
	...
	for i = 1, 2 do
		...
		xyd.setUISpriteAsync(self["buyBtn" .. tostring(i - 1) .. "_button_icon"], nil, tostring(xyd.tables.itemTable:getIcon(tonumber(data[1]))), nil, nil)
