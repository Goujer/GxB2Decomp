-- chunkname: @../../../Product/Bundles/Android/src/app/windows/FairArenaPartnerInfoWindow.lua
	...
	for key = 1, #skill_ids do
		...
		UIEventListener.Get(self.skillIcons[key].go).onPress = function(go, isPressed)
			if isPressed == true then
				self.skillIcons[key]:showTips(true, self.skillDesc, true, nil, nil, function()
