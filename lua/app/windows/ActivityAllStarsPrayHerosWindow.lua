-- chunkname: @../../../Product/Bundles/Android/src/app/windows/ActivityAllStarsPrayHerosWindow.lua
...
function ActivityAllStarsPrayHerosWindow:createChildren()
	...
	xyd.setUISpriteAsync(self.okBtn_button_icon, nil, "icon_" .. data[1], nil, nil)
...
function ActivityAllStarsPrayHerosWindow:unSelectHero(copyIcon)
	...
	local originalIcon, battleHeroIcon, battleHeroIconObj, moveToTarget
