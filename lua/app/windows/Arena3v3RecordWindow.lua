-- chunkname: @../../../Product/Bundles/Android/src/app/windows/Arena3v3RecordWindow.lua
...
function Arena3v3RecordItem:setState(state)
	if state == "win" then
		...
		self.point.color = Color.New2(2751463679)
	end
...
function Arena3v3RecordItem:onclickFight()
	...
	if xyd.models.backpack:getItemNumByID(xyd.ItemID.ARENA_TICKET) >= tonumber(cost) then
		if self.parent_ and self.parent_.parent.isAs_ then
