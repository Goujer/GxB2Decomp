-- chunkname: @../../../Product/Bundles/Android/src/app/windows/ShrineHurdleEntranceWindow.lua
...
function ShrineHurdleEntranceWindow:layout()
	...
	if xyd.Global.lang == "en_en" or xyd.Global.lang == "de_de" then
		xyd.setUISpriteAsync(self.broadcastBtn_, nil, "broadcast_bg_en", nil, nil, true)
	elseif xyd.Global.lang == "fr_fr" then
		xyd.setUISpriteAsync(self.broadcastBtn_, nil, "broadcast_fr", nil, nil, true)
	else
		xyd.setUISpriteAsync(self.broadcastBtn_, nil, "broadcast_bg", nil, nil, true)
	end
