-- chunkname: @../../../Product/Bundles/Android/src/app/windows/GuildNameChangeWindow.lua
...
function GuildNameChangeWindow:initUIComponent()
	...
	self.textInput.defaultColor = Color.New2(3385711103)
...
function GuildNameChangeWindow:isNameValid(name)
	...
	if xyd.getNameStringLength(name) > limit[2] then
