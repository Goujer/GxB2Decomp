-- chunkname: @../../../Product/Bundles/Android/src/app/windows/ActivityPirateSwapWindow.lua
...
function ActivityPirateSwapWindow:onClickSure()
	...
	if costNum > xyd.models.backpack:getItemNumByID(self.cost_[1]) then
