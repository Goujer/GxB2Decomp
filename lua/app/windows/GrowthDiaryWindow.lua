-- chunkname: @../../../Product/Bundles/Android/src/app/windows/GrowthDiaryWindow.lua
...
function MissionItem:setInfo(data)
	...
	local isUnlock = xyd.models.growthDiary:getChapter() >= self.parent_.chapter_
...
function MissionItem:jumpFunction()
	...
	xyd.goWay(jumpID, nil, nil, function()
...
function GrowthDiaryWindow:register()
	...
	UIEventListener.Get(self.awardBtn_).onClick = function()
		local isUnlock = xyd.models.growthDiary:getChapter() >= self.chapter_
...
function GrowthDiaryWindow:updateTopAward()
	...
	if xyd.models.growthDiary:checkCanAward(self.chapter_) and not isAwarded then
		self.awardBtnSprite_.color = Color.New2(4294967295)
		...
		self.awardBtnLabel_.color = Color.New2(4278124287)
