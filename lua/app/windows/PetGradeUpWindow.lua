-- chunkname: @../../../Product/Bundles/Android/src/app/windows/PetGradeUpWindow.lua
...
function PetGradeUpWindow:layout()
	...
	if costs[xyd.ItemID.MANA] > owns[xyd.ItemID.MANA] then
		self.labelCostRes1.color = Color.New2(3422556671)
	else
		self.labelCostRes1.color = Color.New2(1432789759)
	end

	if costs[xyd.ItemID.PET_STONE] > owns[xyd.ItemID.PET_STONE] then
		self.labelCostRes2.color = Color.New2(3422556671)
	else
...
function PetGradeUpWindow:onclickBtnGradeUp()
	...
	if costs[xyd.ItemID.MANA] > owns[xyd.ItemID.MANA] then
		...
		flag = true
	elseif costs[xyd.ItemID.PET_STONE] > owns[xyd.ItemID.PET_STONE] then
