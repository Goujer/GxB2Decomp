-- chunkname: @../../../Product/Bundles/Android/src/app/windows/TimeCloisterCrystalBattleHappenWindow.lua
...
function TimeCloisterCrystalBattleHappenWindow:layout()
	xyd.setUISpriteAsync(self.titleImg, nil, "time_cloister_card_skill_title_" .. xyd.Global.lang, nil, nil, true)
