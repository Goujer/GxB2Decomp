-- chunkname: @../../../Product/Bundles/Android/src/app/windows/SummonSeniorGiftBagTipsWindow.lua
...
function SummonSeniorGiftBagTipsWindow:initUIComponent()
	...
	if xyd.getServerTime() < 1673568000 then
		xyd.setUISpriteAsync(self.Bg_, nil, "summon_senior_giftbag_bg002", nil, nil, true)
	else
		xyd.setUISpriteAsync(self.Bg_, nil, "summon_senior_giftbag_bg001", nil, nil, true)
		self.Bg_:Y(-32)
...
function SummonSeniorGiftBagTipsWindow:onRefresh()
	...
	for i = 1, count do
		if tonumber(self.params_.times) >= tonumber(__("WISH_GACHA_NUM" .. i)) then
			self["groupTimesNum" .. i].color = Color.New2(4210673663)
			self["groupTimesNum" .. i].effectColor = Color.New2(2941919999)
			self["groupProbNum" .. i].color = Color.New2(4210673663)
			...
			self["groupTimesNum" .. i].color = Color.New2(4278124287)
			self["groupTimesNum" .. i].effectColor = Color.New2(523263999)
			self["groupProbNum" .. i].color = Color.New2(4110352383)
	...
	if tonumber(self.params_.times) >= tonumber(__("WISH_GACHA_NUM" .. count)) then
