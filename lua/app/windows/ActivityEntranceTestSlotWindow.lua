-- chunkname: @../../../Product/Bundles/Android/src/app/windows/ActivityEntranceTestSlotWindow.lua
...
function ActivityEntranceTestSlotWindow:registerEvent()
	...
	xyd.setUISpriteAsync(imgChoose, nil, "partner_sort_bg_chosen_01", nil, nil)

	local imgUnChoose = self.sortPop:NodeByName("tab_10"):ComponentByName("unchosen", typeof(UISprite))

	xyd.setUISpriteAsync(imgUnChoose, nil, "partner_sort_bg_unchosen_01", nil, nil)
end
