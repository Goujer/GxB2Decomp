-- chunkname: @../../../Product/Bundles/Android/src/app/windows/ActivityChristmasSaleAwardSelectWindow.lua
...
function ActivityChristmasSaleAwardSelectWindow:updateNextBtn()
	...
	if num and flag or self.opAwards[self.curIndex] and num > self.curIndex then
...
function ActivityChristmasSaleAwardSelectWindow:updateAwardPool(index)
	...
	for i = 1, #list do
		...
		if data.leftTimes == 0 then
			labelNum.color = Color.New2(3422556671)
		end
