-- chunkname: @../../../Product/Bundles/Android/src/app/windows/ShrineHurdleStoryWindow.lua
...
function LeftItem:checkShowSelf(showID)
	...
	if self.isShow_ then
		self.tab1Label_.color = Color.New2(4294967295)
		...
		self.tab1Label_.effectColor = Color.New2(4294967295)
...
function LeftItem:updateSelectState()
	...
	for tab2id, item in pairs(self.selectItemList_) do
		if tab2id == self.selectTab2_ then
			...
			item.text.color = Color.New2(4294967295)
		else
