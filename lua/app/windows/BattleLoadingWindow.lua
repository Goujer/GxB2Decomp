-- chunkname: @../../../Product/Bundles/Android/src/app/windows/BattleLoadingWindow.lua
...
function BattleLoadingWindow:adaptX()
	...
	if height >= xyd.Global.getMaxHeight() then
...
function BattleLoadingWindow:getSenpaiDressList(enemyInfo, selfInfo, battleType)
	...
	for i = 1, #dressIds do
		local enemyStyleID, selfStyleID
