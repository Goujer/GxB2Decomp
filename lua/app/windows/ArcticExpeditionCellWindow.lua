-- chunkname: @../../../Product/Bundles/Android/src/app/windows/ArcticExpeditionCellWindow.lua
...
function ArcticExpeditionCellWindow:onClickFightBtn()
	...
	if self.cellInfo_.group == self.activityData_:getSelfGroup() and self.cellInfo_.num >= xyd.tables.arcticExpeditionCellsTypeTable:getBattleCount2(self.cellType_) then
...
function ArcticExpeditionCellWindow:showNormalCell()
	...
	if not self:checkCanFight() or self.cellInfo_.group == self.activityData_:getSelfGroup() and self.cellInfo_.num >= xyd.tables.arcticExpeditionCellsTypeTable:getBattleCount2(self.cellType_) or -self.activityData_:startTime() + xyd.getServerTime() < xyd.DAY_TIME or self.activityData_:getEndTime() - xyd.getServerTime() <= xyd.DAY_TIME then
		xyd.applyChildrenGrey(self.fightBtn_)
	end
end
