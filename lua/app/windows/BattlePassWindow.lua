-- chunkname: @../../../Product/Bundles/Android/src/app/windows/BattlePassWindow.lua
...
function BattlePassWindow:openBuyWindow()
	...
	elseif self.activityData.detail.charges[1].buy_times > 0 then
		showType = self.activityData.detail.charges[2].buy_times > 0 and "buyAll" or "buyOne"
	end
...
function BattlePassWindow:initLayout()
	local chosen = {
		color = Color.New2(2439060479),
		effectColor = Color.New2(4294833407)
	}
	local unchosen = {
		color = Color.New2(4277988351),
