-- chunkname: @../../../Product/Bundles/Android/src/app/windows/StoryWindow.lua
...
function StoryWindow:initTable()
	...
	elseif self.storyType_ == xyd.StoryType.ACTIVITY_PIRATE then
		self.storyTable_ = xyd.tables.activityPiratePlotTable
	end
end
...
function StoryWindow:playExitEffect(nextID)
	...
	function callback()
		...
		if self.last_partner_img == nil or cardRes_ and string.find(cardRes_, "partner_avatar") then
			-- block empty
