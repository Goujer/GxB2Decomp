-- chunkname: @../../../Product/Bundles/Android/src/app/windows/ExploreBaseBuildingWindow.lua
...
function ExploreBaseBuildingWindow:getUIComponent()
	...
	for i = 1, 2 do
		...
		self.groupLabelMiddle[i][1] = groupFormation:ComponentByName("labelLevel", typeof(UILabel))
...
function ExploreBaseBuildingWindow:updateContent()
	...
	flag = flag and maxLev > self.data.level
