-- chunkname: @../../../Product/Bundles/Android/src/app/windows/ArcticExpeditionAwardWindow.lua
...
function ArcticExpeditionAwardWindow:onclickNav(index)
	if index == 1 then
		...
		self.nav1Label.color = Color.New2(4294967295)
		self.nav1Label.effectColor = Color.New2(1012112383)
		self.nav2Label.color = Color.New2(960513791)
		self.nav2Label.effectColor = Color.New2(4294967295)
	else
		...
		self.nav2Label.color = Color.New2(4294967295)
		self.nav2Label.effectColor = Color.New2(1012112383)
		self.nav1Label.color = Color.New2(960513791)
		self.nav1Label.effectColor = Color.New2(4294967295)
	end
end
...
function ArcticExpeditionAwardWindow:updateDDL1()
	...
	duration = endTime <= serverTime and 0 or endTime - serverTime
