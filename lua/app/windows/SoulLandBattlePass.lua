-- chunkname: @../../../Product/Bundles/Android/src/app/windows/SoulLandBattlePass.lua
...
function FundItem:update(_, info)
	...
	if self.info.scoreNow >= self.info.scoreNeed and self.info.isBaseAwarded == false then
	...
	elseif self.info.exBuy == true and self.info.scoreNow >= self.info.scoreNeed and self.info.isAdvanceAwarded == false then
	...
	elseif self.info.exBuy == false and self.info.scoreNow >= self.info.scoreNeed then
