-- chunkname: @../../../Product/Bundles/Android/src/app/windows/GalaxyStartWindow.lua
...
function GalaxyStartWindow:layout()
	...
	if leftTime <= 2 * xyd.DAY_TIME and leftTime > xyd.DAY_TIME and leftTime > 0 then
	...
	for i = 1, 2 do
		UIEventListener.Get(self["group" .. tostring(i)]).onClick = function()
			...
			xyd.WindowManager:get():openWindow(winName, {}, function()
				xyd.WindowManager.get():closeWindow(self.name_, nil, nil, true)
			end)
		end
	end
end
