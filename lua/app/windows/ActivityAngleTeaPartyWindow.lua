-- chunkname: @../../../Product/Bundles/Android/src/app/windows/ActivityAngleTeaPartyWindow.lua
...
function ActivityAngleTeaPartyWindow:registerEvent()
	...
	UIEventListener.Get(self.gotoBtn).onClick = handler(self, function()
		...
		self:goWay(getwayID, nil, nil, function()
...
function ActivityAngleTeaPartyWindow:updateState()
	...
	for i = 1, 4 do
		if self.activityData.detail.point >= self.activityData.needPoints[i] or self.activityData.detail.charges[1].buy_times > 0 then
