-- chunkname: @../../../Product/Bundles/Android/src/app/windows/NewTrialBattlepassBuyPointWindow.lua
...
function NewTrialBattlepassBuyPointWindow:register()
	...
	UIEventListener.Get(self.scoreBtn_).onClick = function()
		...
		if self.purchaseNum_ > self.activityData:getRestCanBuy() then
