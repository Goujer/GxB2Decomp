-- chunkname: @../../../Product/Bundles/Android/src/app/windows/ActivitySpaceExplorePartnerUpWindow.lua
...
function ActivitySpaceExplorePartnerUpWindow:layout()
	...
	xyd.setUISpriteAsync(self.levelImg, nil, "activity_space_explore_icon_level_" .. type, nil, nil)
...
function ActivitySpaceExplorePartnerUpWindow:updateCostNum()
	...
	if now_num < need_num then
		self.puzzleLabelLeft.color = Color.New2(3422556671)
	else
