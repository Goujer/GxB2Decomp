-- chunkname: @../../../Product/Bundles/Android/src/app/windows/ActivityPopularityVoteWindow.lua
...
function ActivityPopularityVoteWindow:getDailyTaskList()
	...
	table.sort(taskList, function(a, b)
		local canAwardA = a.count >= a.complete and a.isAwarded == 0 and 100 or 0
		local canAwardB = b.count >= b.complete and b.isAwarded == 0 and 100 or 0
