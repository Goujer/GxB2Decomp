-- chunkname: @../../../Product/Bundles/Android/src/app/windows/SchoolChooseWindow.lua
...
function SchoolChooseWindow:updateUpIcon()
	if xyd.models.activity:isResidentReturnAddTime() then
		...
		xyd.setUISpriteAsync(self.btnTavern_upIcon.gameObject:GetComponent(typeof(UISprite)), nil, "common_tips_up_" .. return_multiple, nil, nil, nil)
	else
