-- chunkname: @../../../Product/Bundles/Android/src/app/windows/TimeCloisterCardDetailWindow.lua
...
function TimeCloisterCardDetailWindow:layout()
	...
	if isShowDown then
		...
		if time_cloister_probe_wd and time_cloister_probe_wd:getCloister() then
			...
			if self.info and self.info[tec_id] and self.info[tec_id].curLv >= self.info[tec_id].maxLv then
