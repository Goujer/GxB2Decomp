-- chunkname: @../../../Product/Bundles/Android/src/app/windows/ActivityStarChargeWindow.lua
...
function ActivityStarChargeWindow:layout()
	if self.wndType == 1 then
		xyd.setUISpriteAsync(self.logo_, nil, "activity_star_altar_login_logo_" .. xyd.Global.lang, nil, nil, true)
		self:initLogin()
	elseif self.wndType == 2 and self.activityDataCharge then
		xyd.setUISpriteAsync(self.logo_, nil, "activity_star_altar_charge_logo2_" .. xyd.Global.lang, nil, nil, true)
		self:initGiftBag()
	end
end
