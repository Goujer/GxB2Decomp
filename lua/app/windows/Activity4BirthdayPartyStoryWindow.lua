-- chunkname: @../../../Product/Bundles/Android/src/app/windows/Activity4BirthdayPartyStoryWindow.lua
...
function Activity4BirthdayPartyStoryItem:setInfo(params)
	...
	if self.state == 1 then
		...
		self.labeDesc.effectColor = Color.New2(2593496831)
	else
		self.labeIndex.color = Color.New2(4294967295)
		self.labeIndex.effectStyle = UILabel.Effect.Outline8
		self.labeIndex.effectColor = Color.New2(2423309823)
		self.labeDesc.effectColor = Color.New2(4294967295)
	end
