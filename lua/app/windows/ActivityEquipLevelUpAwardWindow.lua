-- chunkname: @../../../Product/Bundles/Android/src/app/windows/ActivityEquipLevelUpAwardWindow.lua
...
function ActivityEquipLevelUpAwardItem:updateInfo()
	...
	if self.data[2] >= xyd.tables.activityEquipLevelUpTable:getLimit(self.data[1]) then
