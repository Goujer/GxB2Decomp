-- chunkname: @../../../Product/Bundles/Android/src/app/windows/HouseItemDetailWindow.lua
...
function HouseItemDetailWindow:initSelectNum()
	...
	local function addCallback()
		if self.purchaseNum > maxCanBuy then
...
function HouseItemDetailWindow:updateCost()
	...
	if total < costNum * self.purchaseNum then
		self.labelTotal_.color = Color.New2(3422556671)
	else
