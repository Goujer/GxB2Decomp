-- chunkname: @../../../Product/Bundles/Android/src/app/windows/ActivityTimeLimitCallAwardWindow.lua
...
function ActivityTimeLimitCallAwardWindow:updateMissionGroup(init)
	local tableUse, itemList, awardsdata, tipsText, point, ids
...
function ActivityTimeLimitCallAwardWindow:onGetAward(event)
	...
	xyd.itemFloat(awardItems, nil, nil, 7000)
end
