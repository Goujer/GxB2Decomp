-- chunkname: @../../../Product/Bundles/Android/src/app/windows/ActivityStarPlanMissionWindow.lua
...
function MissionItem:setInfo(id, buytimes, hasAwarded)
	...
	if self.hasAwarded and self.hasAwarded == 1 then
		...
		xyd.setUISpriteAsync(self.finishImg_, nil, "mission_awarded_" .. xyd.Global.lang, nil, nil, true)
	else
