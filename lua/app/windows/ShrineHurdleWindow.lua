-- chunkname: @../../../Product/Bundles/Android/src/app/windows/ShrineHurdleWindow.lua
...
function ShrineHurdleWindow:initWindow()
	...
	not_auto_open = guideIndex == 1 and true or false
...
function ShrineHurdleWindow:getUIComponent()
	...
	xyd.setUISpriteAsync(self.battleBtn_:GetComponent(typeof(UISprite)), nil, "shrine_hurdle_battle_" .. xyd.Global.lang, nil, nil, true)
end
