-- chunkname: @../../../Product/Bundles/Android/src/app/windows/ArcticExpeditionRankWindow.lua
...
function SportsRankItem:layout()
	...
	if self.group_ then
		if self.group_ == 0 then
			...
			xyd.setUISpriteAsync(self.groupImg, nil, "arctic_expedition_cell_group_icon_" .. self.group_, nil, nil)
		end
	end
