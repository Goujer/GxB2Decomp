-- chunkname: @../../../Product/Bundles/Android/src/app/windows/ActivityPopularityVoteSurveyEntranceWindow.lua
...
function ActivityPopularityVoteSurveyEntranceWindow:initUIComponent()
	xyd.setUISpriteAsync(self.imgText, nil, "activity_popularity_vote_survey_text_" .. xyd.Global.lang, nil, nil, true)
