-- chunkname: @../../../Product/Bundles/Android/src/app/windows/Activity4BirthdayChoiceAwardWindow.lua
...
function Activity4BirthdayChoiceAwardWindow:initBigNav()
	local labelStates = {
		chosen = {
			...
			effectColor = Color.New2(2318428671)
		},
		unchosen = {
			color = Color.New2(960513791),
			effectColor = Color.New2(4243908351)
		}
	}
...
function ShowIconItem:initUI()
	self:getUIComponent()
	xyd.setUISpriteAsync(self.isHasImg, nil, "activity_4birthday_musci_bg_yhd_" .. xyd.Global.lang, nil, nil, true)
end
