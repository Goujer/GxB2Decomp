-- chunkname: @../../../Product/Bundles/Android/src/app/windows/GuildNewWarSetDefPlayerWindow.lua
...
function GuildNewWarSetDefPlayerWindow:updateTabGroup()
	...
	for i = 1, 3 do
		...
		if i == self.filterIndex then
			self["labelTab" .. i].color = Color.New2(4294967295)
			...
			self["labelTab" .. i].effectColor = Color.New2(4294967295)
