-- chunkname: @../../../Product/Bundles/Android/src/app/windows/ActivityWorldBossSweepWindow.lua
...
function ActivityWorldBossSweepWindow:layout()
	xyd.setUISpriteAsync(self.iconImg_, nil, xyd.tables.itemTable:getIcon(28), nil, nil)
