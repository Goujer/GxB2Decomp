-- chunkname: @../../../Product/Bundles/Android/src/app/windows/ActivitySpaceExploreBattleWindow.lua
...
function ActivitySpaceExploreBattleWindow:layout()
	xyd.setUISpriteAsync(self.bg_left, nil, "activity_space_explore_bg_vs_1", nil, nil)
	xyd.setUISpriteAsync(self.bg_right, nil, "activity_space_explore_bg_vs_2", nil, nil)
...
function ActivitySpaceExploreBattleWindow:playOverShow()
	...
	vs_tween:AppendCallback(function()
		...
		if self.self_blood <= 0 then
			xyd.setUISpriteAsync(self.bg_left, nil, "activity_space_explore_bg_vs_1_1", nil, nil)
			self.bg_left_mask:SetActive(true)
		end

		if self.enemy_hp <= 0 then
			xyd.setUISpriteAsync(self.bg_right, nil, "activity_space_explore_bg_vs_2_2", nil, nil)
