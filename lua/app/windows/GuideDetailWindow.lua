-- chunkname: @../../../Product/Bundles/Android/src/app/windows/GuideDetailWindow.lua
...
function GuideDetailWindow:onclickZoom(event)
	GuideDetailWindow.super.onclickZoom(self, event, true)
end
