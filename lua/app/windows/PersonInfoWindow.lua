-- chunkname: @../../../Product/Bundles/Android/src/app/windows/PersonInfoWindow.lua
...
function PersonInfoWindow:layout()
	...
	for i = 1, 2 do
		xyd.setUISpriteAsync(self["lebelBtn" .. i], nil, "person_skin_mark_bg" .. i, nil, nil, nil)
...
function PersonInfoWindow:registerEvent()
	...
	UIEventListener.Get(self.lebelBtn1.gameObject).onClick = function()
		if not self.pageCon1.gameObject.activeSelf then
			...
			self.pageCon1:SetActive(true)
			self.pageCon2:SetActive(false)
			xyd.setUISpriteAsync(self.lebelBtn1, nil, "person_skin_mark_bg1", nil, nil, nil)
			xyd.setUISpriteAsync(self.lebelBtn2, nil, "person_skin_mark_bg2", nil, nil, nil)
		end
	end
	UIEventListener.Get(self.lebelBtn2.gameObject).onClick = function()
		if not self.pageCon2.gameObject.activeSelf then
			...
			xyd.setUISpriteAsync(self.lebelBtn1, nil, "person_skin_mark_bg2", nil, nil, nil)
			xyd.setUISpriteAsync(self.lebelBtn2, nil, "person_skin_mark_bg1", nil, nil, nil)
		end
	end
