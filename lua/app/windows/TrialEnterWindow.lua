-- chunkname: @../../../Product/Bundles/Android/src/app/windows/TrialEnterWindow.lua
...
function TrialEnterWindow:setLayout()
	...
	if not data or data.start_time == nil or xyd.getServerTime() > data.start_time then
...
function TrialEnterWindow:initGirl()
	...
	bubble:setBubble(nil, Color.New2(1061442047), nil, nil)
...
function TrialEnterWindow:updatePrivilegeCard()
	...
	if privilegeData:getStateById(xyd.GIFTBAG_ID.PRIVILEGE_CARD_TRIAL) == true then
		...
		self.privilegeCardLabel.color = Color.New2(3506416383)
		...
		self.privilegeCardLabel.color = Color.New2(4160157439)
