-- chunkname: @../../../Product/Bundles/Android/src/app/windows/SchoolGiftbagExchangeWindow.lua
...
function SchoolGiftbagExchangeWindow:updateData(exchange_status)
	...
	for i = 1, #exchange_status do
		...
		lock_status = exchange_status[i] == 0 and ((condition_id == -1 or exchange_status[condition_id + 1] ~= 0) and 1 or 0) or 2
...
function SchoolGiftbagExchangeWindow:updateDataWithoutSort(exchange_status)
	...
	for i = 1, #item_status do
		...
		lock_status = exchange_status[id] == 0 and ((condition_id == -1 or exchange_status[condition_id + 1] ~= 0) and 1 or 0) or 2
