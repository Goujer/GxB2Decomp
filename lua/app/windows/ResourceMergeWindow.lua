-- chunkname: @../../../Product/Bundles/Android/src/app/windows/ResourceMergeWindow.lua
...
function ResourceMergeWindow:initUIComponent()
	...
	if self:costEnough() == false then
		self.labelCost.color = Color.New2(4278190335)
	else
...
function ResourceMergeWindow:costEnough()
	if self.needCoin > xyd.models.backpack:getItemNumByID(xyd.ItemID.MANA) then
		return false
	else
		return true
	end
