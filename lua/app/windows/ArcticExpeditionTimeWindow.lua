-- chunkname: @../../../Product/Bundles/Android/src/app/windows/ArcticExpeditionTimeWindow.lua
...
local navStatus = {
	choose = {
		labelColor = Color.New2(4294967295),
		labelEffectColor = Color.New2(1012112383)
	},
	unchoose = {
		labelColor = Color.New2(960513791),
		labelEffectColor = Color.New2(4294967295)
	}
}
...
function ArcTicMissionItem:setInfo(id, data)
	...
	if is_completed and is_completed >= 1 and limitTime <= 1 then
		...
		xyd.setUISpriteAsync(self.completeImg_, nil, "mission_awarded_" .. xyd.Global.lang, nil, nil, true)
...
function ArcticExpeditionTimeWindow:layout()
	...
	if self.eraID_ > self.chooseNav_ then
