-- chunkname: @../../../Product/Bundles/Android/src/app/windows/ArenaAllServerQuizResultWindow.lua
...
function ArenaAllServerQuizResultWindow:initEffect()
	...
	self.labelTips_.color = isWin and Color.New2(2822897919) or Color.New2(960513791)
