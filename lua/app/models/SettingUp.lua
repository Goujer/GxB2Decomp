-- chunkname: @../../../Product/Bundles/Android/src/app/models/SettingUp.lua
...
function SettingUp:sortServerInfo()
	...
	table.sort(infos, function(a, b)
		...
		if a.server_id > b.server_id then
			valA = valA + 50
...
function SettingUp:updateGetNoticeReadList()
	...
	for _, data in ipairs(noticeDatas) do
		...
		if data.end_time >= xyd.getServerTime() and data.start_time <= xyd.getServerTime() then
			self.needRedList[id] = 1
		elseif xyd.getServerTime() > data.end_time and index > 0 then
