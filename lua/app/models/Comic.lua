-- chunkname: @../../../Product/Bundles/Android/src/app/models/Comic.lua
...
function Comic:setRedMark()
	...
	if tmpChapter >= self.comicNum or not xyd.checkFunctionOpen(xyd.FunctionID.COMIC, true) or xyd.Global.lang == "de_de" or xyd.Global.lang == "ko_kr" then
