-- chunkname: @../../../Product/Bundles/Android/src/app/models/ACDFA.lua
...
function AC_DFA:initACDFA(strs)
	...
	if error > -1 then
		...
		errorInfo.error = "ACDFA partner Name is undefined, id: " .. tostring(error) .. " " .. tostring(xyd.Global.lang)
		errorInfo.player_id = xyd.Global.playerID
		errorInfo.osType = xyd.Global.osType_
