-- chunkname: @../../../Product/Bundles/Android/src/app/models/Dungeon.lua
...
function Dungeon:onFight(event)
	...
	if not oldData.max_stage or data.current_stage and data.current_stage > oldData.max_stage then
...
function Dungeon:isAllPass()
	return self:getCurStage() > self:getMaxStage()
end
