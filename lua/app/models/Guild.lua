-- chunkname: @../../../Product/Bundles/Android/src/app/models/Guild.lua
...
function Guild:updateBossRedMark()
	...
	if self.bossID > xyd.tables.miscTable:getNumber("guild_boss_max_id", "value") then
		xyd.models.redMark:setMark(xyd.RedMarkType.GUILD_BOSS, false)
...
function Guild:onGuildBossBroadCast(event)
	...
	if data.boss_id > self.bossID_ then
...
function Guild:getGuildCompetitionLeftTime()
	...
	if guildCompetitionData and xyd.getServerTime() >= guildCompetitionData:startTime() then
