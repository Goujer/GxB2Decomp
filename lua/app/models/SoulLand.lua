-- chunkname: @../../../Product/Bundles/Android/src/app/models/SoulLand.lua
...
function SoulLand:partnerLvUpCheckOpen(lev)
	if not self:checkIsOpen() and lev >= xyd.tables.miscTable:getNumber("soul_land_open_lvl", "value") then
		self:onSendLandBaseInfo()
	end
end
