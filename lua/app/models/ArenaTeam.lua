-- chunkname: @../../../Product/Bundles/Android/src/app/models/ArenaTeam.lua
...
function ArenaTeam:updateRedMark()
	...
	elseif self:getApplyList() and #self:getApplyList() > 0 and not self:getIsJoin() and (not self:getTeamId() or not (self:getTeamId() > 0)) then
		xyd.models.redMark:setMark(xyd.RedMarkType.ARENA_TEAM, true)
	elseif self:getInviteTeams() and #self:getInviteTeams() > 0 and not self:getIsJoin() and (not self:getTeamId() or not (self:getTeamId() > 0)) then
		xyd.models.redMark:setMark(xyd.RedMarkType.ARENA_TEAM, true)
	else
