-- chunkname: @../../../Product/Bundles/Android/src/app/models/datas/ActivityChimeData.lua
...
function ActivityChimeData:getRedMarkState()
	...
	if self.oldCostIdNum1 >= self.itemShow1[2] then
		return true
	end

	if self.oldCostIdNum2 >= self.itemShow2[2] then
		return true
	end
