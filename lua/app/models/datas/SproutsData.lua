-- chunkname: @../../../Product/Bundles/Android/src/app/models/datas/SproutsData.lua
...
function SproutsData:getRedMarkState2()
	...
	for i = 1, #Ids do
		...
		if height_ <= height and awards[i] and awards[i] == 0 then
			flag1 = true
...
function SproutsData:getRedMarkState3()
	...
	for i = 1, #Ids do
		if pr_times >= PartnerAwardTable:getPoint(i) and pr_awards[i] == 0 then
			flag2 = true
