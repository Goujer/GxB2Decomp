-- chunkname: @../../../Product/Bundles/Android/src/app/models/datas/ActivityIceSecretGiftbagData.lua
...
function ActivityIceSecretGiftbagData:getRedMarkState()
	...
	if timeDays == nil then
		...
		if round ~= tonumber(timeDays) and self:getEndTime() > xyd.getServerTime() then
			xyd.models.redMark:setMark(xyd.RedMarkType.ACTIVITY_ICE_SECRET_GIFTBAG, true)
