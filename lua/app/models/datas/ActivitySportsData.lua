-- chunkname: @../../../Product/Bundles/Android/src/app/models/datas/ActivitySportsData.lua
...
function ActivitySportsData:checkAchieveRedPoint()
	...
	for key, item in pairs(list) do
		if item.achieve_id > 0 and item.value >= a_t:getCompleteValue(item.achieve_id) then
