-- chunkname: @../../../Product/Bundles/Android/src/app/models/datas/MonthlyGiftBag.lua

local json = require("cjson")
local ActivityData = import("app.models.ActivityData")
local GiftBagData = import("app.models.datas.GiftBagData")
local MonthlyGiftBag = class("MonthlyGiftBag", GiftBagData, true)

function MonthlyGiftBag:getUpdateTime()
...
function MonthlyGiftBag:onAward(giftBagID)
