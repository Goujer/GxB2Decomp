-- chunkname: @../../../Product/Bundles/Android/src/app/models/datas/ActivityLegendarySkinData.lua
...
function ActivityLegendarySkinData:checkShopRed()
	...
	for index, id in ipairs(ids) do
		...
		if limit == 1 and (not buy_times[index] or buy_times[index] <= 0) and xyd.models.backpack:getItemNumByID(cost[1]) >= cost[2] then
			return true
		end
	end
