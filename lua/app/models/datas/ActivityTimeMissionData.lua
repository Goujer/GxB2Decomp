-- chunkname: @../../../Product/Bundles/Android/src/app/models/datas/ActivityTimeMissionData.lua
...
function ActivityTimeMissionData:getRedMarkState()
	...
	for i, value in pairs(self.detail.m_awards) do
		...
		if value == 0 and compelte_num <= self.detail.values[i] and day >= xyd.tables.activityTimeMissionTable:getTime(i) then
			flag = true
