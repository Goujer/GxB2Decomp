-- chunkname: @../../../Product/Bundles/Android/src/app/models/datas/ActivityBlindBoxBattlePassData.lua
...
function ActivityBlindBoxBattlePassData:getRedMarkState()
	...
	for _, info in ipairs(fundItemList) do
		if info.dayNow >= info.dayNeed and info.isBaseAwarded == false or info.dayNow >= info.dayNeed and info.isAdvanceAwarded == false and info.giftBag1Buy == true or info.dayNow >= info.dayNeed and info.isSuperAwarded == false and info.giftBag2Buy == true then
