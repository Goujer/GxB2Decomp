-- chunkname: @../../../Product/Bundles/Android/src/app/models/datas/Activity3BirthdayVipData.lua
...
function Activity3BirthdayVipData:getRedMarkState()
	...
	if self.isNeedDeal then
		...
		for i, id in ipairs(ids) do
			if vipLev >= xyd.tables.activity3BirthdayVipAwardTable:getVipLevel(id) and self.detail.awards[i] == 0 then
				flag = true
