-- chunkname: @../../../Product/Bundles/Android/src/app/models/datas/SoulLandBattlePassData.lua
...
function SoulLandBattlePassData:getRedMarkState()
	...
	for _, info in ipairs(fundItemList) do
		if info.scoreNow >= info.scoreNeed and info.isBaseAwarded == false or info.scoreNow >= info.scoreNeed and info.isAdvanceAwarded == false and info.exBuy == true then
			return true
		end
	end
