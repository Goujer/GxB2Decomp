-- chunkname: @../../../Product/Bundles/Android/src/app/models/datas/ActivityEnergySummonData.lua
...
function ActivityEnergySummonData:getRedMarkState()
	...
	if self:getEnergy() >= self:getLimitEnergy() and TodayVisit < self:getEndTime() - 1 then
		return true
	end
