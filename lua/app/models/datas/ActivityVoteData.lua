-- chunkname: @../../../Product/Bundles/Android/src/app/models/datas/ActivityVoteData.lua
...
function ActivityVoteData:getRedMarkState()
	...
	for i = 1, #mission_count do
		if mission_count[i] >= xyd.tables.activityWeddingVoteMissionTable:getComplete(i) and not mission_awarded[i] then
			return true
		end
	end
