-- chunkname: @../../../Product/Bundles/Android/src/app/models/datas/ActivityGoldfishData.lua
	...
	for i = 1, 4 do
		if self:checkUnlock(i) then
			...
			for _, id in ipairs(ids) do
				...
				if limit > awards[id] and xyd.models.backpack:getItemNumByID(xyd.ItemID.GOLDFISH_ICON) >= cost[2] then
					return true
				end
			end
		end
