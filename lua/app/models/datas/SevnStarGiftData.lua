-- chunkname: @../../../Product/Bundles/Android/src/app/models/datas/SevnStarGiftData.lua

local json = require("cjson")
local ActivityData = import("app.models.ActivityData")
local SevnStarGiftData = class("SevnStarGiftData", ActivityData, true)

function SevnStarGiftData:onAward(giftBagID)
