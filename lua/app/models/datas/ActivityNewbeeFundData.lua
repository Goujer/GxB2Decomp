-- chunkname: @../../../Product/Bundles/Android/src/app/models/datas/ActivityNewbeeFundData.lua
...
function ActivityNewbeeFundData:getEndTime()
	...
	if tonumber(startTime) >= tonumber(newTime) then
		self.isNew_ = true
	end
...
function ActivityNewbeeFundData:isHide()
	...
	if xyd.getServerTime() > tonumber(endtimeNum) then
		return true
	end
