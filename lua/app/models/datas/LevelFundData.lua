-- chunkname: @../../../Product/Bundles/Android/src/app/models/datas/LevelFundData.lua
...
function LevelFundData:isHide()
	...
	if limitNum > self.detail.charges[1].buy_times then
		return false
	elseif xyd.models.backpack:getLev() >= xyd.tables.activityLevelUpTable:getLevel(#xyd.tables.activityLevelUpTable:getIds()) then
		return true
	end
