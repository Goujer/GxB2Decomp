-- chunkname: @../../../Product/Bundles/Android/src/app/models/datas/ActivityVote2Data.lua
...
function ActivityVote2Data:getRedMarkState()
	...
	missionRedStatus = (not time or not xyd.isToday(tonumber(time)) or false) and true
