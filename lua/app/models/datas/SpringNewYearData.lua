-- chunkname: @../../../Product/Bundles/Android/src/app/models/datas/SpringNewYearData.lua
	...
	if self.isCheckCountRed then
		...
		for i, index in pairs(self.detail.limits) do
			if index == 0 then
				...
				if isHaveBuyPartner and xyd.models.backpack:getItemNumByID(xyd.ItemID.SPRING_NEW_YEAR) >= xyd.tables.activitySpringFestivalAwardTble:getCost(i)[2] then
					isHasRed = true
