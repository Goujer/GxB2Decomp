-- chunkname: @../../../Product/Bundles/Android/src/app/models/datas/ActivityDailyRechargeData.lua
...
function ActivityDailyRechargeData:getRedMarkState()
	...
	red = self.detail.award_times > 0 and #self.detail.award_ids < 15 and true or self.detail.free_times == 0 and true or false
