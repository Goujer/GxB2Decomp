-- chunkname: @../../../Product/Bundles/Android/src/app/models/datas/SubscriptionData.lua
...
function SubscriptionData:onAward(giftBagID)
	...
	elseif self.detail.end_time > xyd.getServerTime() then
...
function SubscriptionData:backRank()
	...
	if tonumber(data.end_time) > xyd.getServerTime() then
		return true
	end
