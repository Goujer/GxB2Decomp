-- chunkname: @../../../Product/Bundles/Android/src/app/models/datas/ActivityTimeGambleData.lua
...
function ActivityTimeGambleData:onTimeRefresh(event)
	...
	if refreshFreeTimes > self.detail_.refresh then
