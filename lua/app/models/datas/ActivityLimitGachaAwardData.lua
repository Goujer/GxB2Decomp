-- chunkname: @../../../Product/Bundles/Android/src/app/models/datas/ActivityLimitGachaAwardData.lua
...
function ActivityLimitGachaAwardData:getMaxIndex()
	...
	for i = 1, 5 do
		...
		for j = 1, #ids do
			if xyd.tables.activityLimitExchangeAwardTable:getLimit(ids[j]) > times[ids[j]] then
				return i
			end
		end
	end
