-- chunkname: @../../../Product/Bundles/Android/src/app/models/datas/WelfareSaleData.lua
...
function WelfareSaleData:getRedMarkState()
	...
	for i = 1, #ids do
		...
		if point >= WelfareSaleTable:getRequirement(id) and self.detail.buy_times[id] < WelfareSaleTable:getLimit(id) then
