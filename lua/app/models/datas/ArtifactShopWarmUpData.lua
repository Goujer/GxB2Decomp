-- chunkname: @../../../Product/Bundles/Android/src/app/models/datas/ArtifactShopWarmUpData.lua
...
function ArtifactShopWarmUpData:getCanResitScore()
	...
	if self.detail.point + CanResitScore > xyd.tables.activityMissionPointTable:getTotalPoint() then
