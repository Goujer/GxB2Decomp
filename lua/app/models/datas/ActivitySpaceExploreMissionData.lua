-- chunkname: @../../../Product/Bundles/Android/src/app/models/datas/ActivitySpaceExploreMissionData.lua
...
function ActivitySpaceExploreMissionData:getRedMarkState()
	local function check()
		...
		if timeDays == nil then
			...
			if dayRound ~= tonumber(timeDays) and self:getEndTime() > xyd.getServerTime() then
				return true
			else
				return false
			end
