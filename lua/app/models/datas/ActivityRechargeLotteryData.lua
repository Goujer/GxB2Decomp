-- chunkname: @../../../Product/Bundles/Android/src/app/models/datas/ActivityRechargeLotteryData.lua
...
function ActivityRechargeLotteryData:onItemChange(event)
	...
	for i = 1, #items do
		if items[i].item_id == resItemID then
			if xyd.models.backpack:getItemNumByID(resItemID) > self.resItemNum then
