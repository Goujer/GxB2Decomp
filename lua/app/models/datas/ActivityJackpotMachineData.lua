-- chunkname: @../../../Product/Bundles/Android/src/app/models/datas/ActivityJackpotMachineData.lua
...
function ActivityJackpotMachineData:getRedMarkState()
	...
	for i = 1, #freeIDs do
		if xyd.tables.activityJackpotExchangeTable:getLimit(freeIDs[i]) > self.detail.buy_times[freeIDs[i]] and not self.giftbagRed then
			self.defRedMark = true
		end
	end
