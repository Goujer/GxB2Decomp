-- chunkname: @../../../Product/Bundles/Android/src/app/models/datas/ActivityGropupGiftBag.lua
...
function ActivityGropupGiftBag:changeDetailPart()
	...
	for i = 1, 2 do
		params.charge[i] = {}
		params.charge[i].buy_times = 0
		params.charge[i].start_time = 0
		params.charge[i].table_id = 186 + i
	end
