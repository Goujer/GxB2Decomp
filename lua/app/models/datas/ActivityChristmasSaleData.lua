-- chunkname: @../../../Product/Bundles/Android/src/app/models/datas/ActivityChristmasSaleData.lua
...
function ActivityChristmasSaleData:getRedMarkState()
	...
	for i = 1, #ids do
		...
		flag = requirement <= self.detail.cost and limit > self.detail.limits[i].limit and cost <= hasNum
