-- chunkname: @../../../Product/Bundles/Android/src/app/models/FairArena.lua
...
function FairArena:saveLocalformation(formation)
	...
	dbParams.key = xyd.BattleType.FAIR_ARENA

	xyd.db.formation:addOrUpdate(dbParams)
end

function FairArena:makeEnemyInfo(infos)
	local player_name, lev, avatar_id, avatar_frame_id, server_id
