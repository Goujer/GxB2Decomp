-- chunkname: @../../../Product/Bundles/Android/src/app/models/FriendTeamBoss.lua
...
function FriendTeamBoss:needRemind()
	...
	if teamInfo.team_status ~= tonumber(state) and xyd.getServerTime() - tonumber(time) > xyd.TimePeriod.DAY_TIME then
		return true
	else
		return false
	end
