-- chunkname: @../../../Product/Bundles/Android/src/app/models/PetTraining.lua
...
function PetTraining:getTrainingLevel()
	...
	for i = 1, #ids - 1 do
		if exp >= xyd.tables.petTrainingTable:getExp(ids[i]) and exp < xyd.tables.petTrainingTable:getExp(ids[i + 1]) then
