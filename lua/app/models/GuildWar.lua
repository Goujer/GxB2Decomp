-- chunkname: @../../../Product/Bundles/Android/src/app/models/GuildWar.lua
...
function GuildWar:onGetGuildWarInfo(event)
	...
	saveData.is_signed = data.is_signed
	saveData.energy = data.energy
	saveData.rank = data.rank
	saveData.member_ids = data.member_ids
	saveData.score = data.score
	saveData.hide_ids = data.hide_ids
	saveData.week_start_time = data.week_start_time
	saveData.fight_times = data.fight_times
	saveData.match_info = data.match_info
	...
	for _, teamInfo in ipairs(data.all_teams) do
		...
		params.avatar_id = teamInfo.avatar_id
		params.lev = teamInfo.lev
		params.player_name = teamInfo.player_name
		params.player_id = teamInfo.player_id
		params.partners = teamInfo.partners
		params.power = teamInfo.power
		params.pet = teamInfo.pet or nil
		params.avatar_frame_id = teamInfo.avatar_frame_id
		params.signature = teamInfo.signature
...
function GuildWar:onGetFinalInfo(e)
	...
	self.finalInfo_ = {}
	self.finalInfo_.rounds = rounds
	self.finalInfo_.guilds = guilds
end
