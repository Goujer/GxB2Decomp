-- chunkname: @../../../Product/Bundles/Android/src/app/common/tables/TimeCloisterDressEffectTable.lua
...
function TimeCloisterDressEffectTable:getSkillId(absNum, typeIndex)
	...
	for i, id in ipairs(self.ids_) do
		if absNum >= self:getNumber(i, "num") and (i == #self.ids_ or absNum < self:getNumber(i + 1, "num")) then
			needId = i
