-- chunkname: @../../../Product/Bundles/Android/src/app/common/tables/EquipTable.lua
...
function EquipTable:getDesc(id)
	...
	do
		...
		while i <= 4 do
			...
			local buffName = tostring(xyd.tables.dBuffTable:getDesc(base[1]))

			if buffName ~= "nil" then
				desc = tostring(desc) .. "+" .. tostring(num) .. " " .. buffName
			end
