-- chunkname: @../../../Product/Bundles/Android/src/app/common/tables/BattleTriggerTable.lua
...
function BattleTriggerTable:getRoundLimitTimes(id)
	return self:getNumber(id, "round_limit_times")
end
