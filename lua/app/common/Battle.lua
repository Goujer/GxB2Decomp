-- chunkname: @../../../Product/Bundles/Android/src/app/common/Battle.lua
...
xyd.Battle.maxRound = 15
xyd.Battle.PET_RE_MP = 10
xyd.Battle.PET_ROUND_RE_MP = 20
xyd.Battle.MAX_TEAM_NUM = 12
xyd.Battle.ENERGY_DEFAULT = 100
xyd.Battle.unAuto = false
xyd.Battle.isCure = false
xyd.Battle.isJustCrystal = {}
xyd.Battle.shareHarmBuffs = {}
xyd.Battle.curRoundDie = {}
xyd.Battle.aoeBuffEffect_ = {}
xyd.Battle.randomHandler = nil
xyd.Battle.randomSeed = 0
xyd.Battle.effect_battlecover = "difangchuchang"
xyd.Battle.effect_switch = "switch"
xyd.Battle.effect_battle_time_cloister = "time_cloister_crystal_card"
xyd.Battle.recordSkills = {}
xyd.Battle.unityPosYFlip = -1
xyd.Battle.curBattleType = -1
xyd.Battle.maxSportMeetingRound = 99
xyd.Battle.lastAttacker = nil
xyd.Battle.maxBuffRound = 25

function xyd.Battle.getRequire(class)
	return import("lib.battle." .. class)
end

function xyd.Battle.requireFighter(class)
	if not class then
...
function xyd.Battle.requireBuff(buffName)
...
xyd.TriggerType = {
	...
	AFTER_SELF_PET_SKILL = 158,
	SELF_TEAM_YX_DEBUFF = 129,
	SELF_ATTACKED_ONCE = 178,
	SELF_ATTACKED_BY_ANSUNA_TO_SHIELD = 180,
	SKILL_WITHOUT_PLMXSTRANS = 169,
	...
	ROUND_BEGIN_ALL = 150,
	ENEMY_DIE_HIT = 104,
	SELF_SKILL_HPSHIELD = 151,
	FIRST_DIE_HIT = 153,
	SELF_CONTROLED = 44,
	ROUND_END_OWN_HPSHIELD = 154,
	ODD_ROUND = 93,
	SELF_BLOCK_ATTACK = 156,
	ONLY_FRIEND_PUGONG = 149,
	WEIWEAN_ROUND_BEGIN = 97,
	GOD_ADD_PET_EXSKILL = 157,
	ROUND_END_AFTER_3 = 102,
	SELF_ATTACKED_BY_HP_LOWEST = 167,
	ENEMY_HP_LESS_35 = 64,
	...
	ROUND_PASS_4 = 74,
	SELF_DOT_HURT = 164,
	SPZGL_ALL_HARM_ATTACK = 165,
	SELF_TEAM_FS_SKILL = 86,
	SELF_HEAL_ONCE = 182,
	CLEAN_DEBUFF = 168,
	ROUND_AFTER_6 = 29,
	SKILL_WITH_PLMXSTRANS = 171,
	SKILL_PUGONG_WITH_SHIELD = 172,
	AFTER_BATTLE_START = 175,
	SELF_ATTACKED_BY_RIDICULE = 173,
	SELF_ROUND = 1,
	FIRST_FRIEND_DIE = 159,
	MOONSHADOW_FRIEND_ATTACKED = 95,
	GET_SUCK_REAL_BLOOD = 126,
	FRIEND_CRITED = 16,
	ENEMY_CRIT = 23,
	FRIEND_ATTACKED_BY_BLIND = 181,
	ENEMY_SKILL = 21,
	ADD_DOT = 160,
	SELF_ROUND_END_NO_SKILL = 183,
	FRIEND_NO_BLOCK = 184,
	SELF_SKILL_WITH_CRIT = 185,
	...
	FRIEND_DIE_ROUND_3 = 152,
	SELF_CONTROLED_FIRST = 176,
	SELF_HP_LESS_30 = 10,
	ENEMY_STONE = 48,
	SELF_ATTACKED_WITH_THORNS = 105,
	PUGONG_WITHOUT_PLMXSTRANS = 170,
	...
	SELF_CRITED = 6,
	SELF_ATTACKED_SKILL_PUGONG = 161,
	STUN = 52,
	...
	SELF_HP_LESS_30_OR_ROUND_5 = 174,
	...
	FRIEND_SKILL_WITHOUT_SELF_H_2 = 179,
	ENEMY_STUN = 177,
	ENEMY_FRIGHTEN = 65,
	FRIEND_CRIT = 15,
...
xyd.CRIT_TIME_BASE = 1.5
xyd.TOTAL_SOULS_NUM = 4
xyd.GROUP_NUM = 7
xyd.GROUP_7_BUFF = 26
...
xyd.BUFF_ICE_LESS = "iceless"
xyd.BUFF_STONE_LESS = "stoneless"
xyd.BUFF_STUN_LESS = "stunless"
xyd.BUFF_FORBID_LESS = "forbidless"
xyd.BUFF_STUN = "stun"
xyd.BUFF_ICE = "ice"
...
xyd.BUFF_DIRECT_HURT = "directHurt"
xyd.BUFF_DIRECT_HEAL = "directHeal"
...
xyd.BUFF_CRIT_LIMIT = "critLimit"
xyd.BUFF_DOT_B = "dotB"
xyd.BUFF_DOT_RATE = "dotRate"
...
xyd.BUFF_CRIT_TIME_MAX3 = "CritTimemax3"
...
xyd.BUFF_HARM_SHARE_ONCE = "harmShareOnce"
xyd.BUFF_PLMXS_THORNS = "plmxsThorns"
xyd.BUFF_PLMXS_DEBUFF = "plmxsDebuff"
xyd.BUFF_PLMXS_TRANS = "plmxsTrans"
xyd.BUFF_DEATH_SPD = "deathSpd"
xyd.BUFF_ENERGY_STEAL = "energySteal"
xyd.BUFF_GET_LEAF = "getLeaf"
xyd.BUFF_GET_THORNS = "getThorns"
xyd.BUFF_EXCHANGE_SPD = "exchangeSpd"
xyd.BUFF_XIERKEDI_DOT = "xierkediDot"
xyd.BUFF_XIERKEDI_POWER = "xierkediPower"
...
xyd.BUFF_SPZGL_ALL_HARM = "spzglAllHarm"
xyd.BUFF_SPZGL_HITTED = "spzglHitted"
...
xyd.BUFF_ALL_DMG_RATE = "allDmgRate"
xyd.BUFF_HYPOXIA = "hypoxia"
...
xyd.BUFF_SNOW_WIND_MIX = "snowWindMix"
xyd.BUFF_HP_SHIELD = "hpShield"
xyd.BUFF_NEXT_HURT_CRIT = "nextHurtCrit"
xyd.BUFF_DEGULA_DEBUFF = "degulaDebuff"
xyd.BUFF_DEGULA_COUNT = "degulaCount"
xyd.BUFF_IMMEDIATELY = "immediately"
xyd.BUFF_ENERGY_ALL_HARM = "energyAllHarm"
xyd.BUFF_HURT_B_CRIT = "hurtBCrit"
xyd.BUFF_ENERGY_GET_RATE = "energyGetRate"
xyd.BUFF_ATK_PMAX_TIMES = "atkPmaxTimes"
xyd.BUFF_DOT_DOUBLE = "dotDouble"
xyd.BUFF_DOT_MARK_ALL_DMG = "dotMarkAllDmg"
xyd.BUFF_HP_SHIELD_FROM_HEAL = "hpShieldFromHeal"
xyd.BUFF_HP_SHIELD_ALL_DMG = "hpShieldAllDmg"
xyd.BUFF_HP_PERCENT_HEAL_B = "hpPercentHealB"
xyd.BUFF_HURT_SELF_HP_LOSE = "hurtSelfHpLose"
xyd.BUFF_ATKP_BY_HP_MAX = "atkPByHpMax"
xyd.BUFF_FS_ALL_DMG = "fsAllDmg"
xyd.BUFF_MS_ALIVE_ALL_DMG = "msAliveAllDmg"
xyd.BUFF_CRIT_OVERFLOW = "critOverflow"
xyd.BUFF_RESTRAINTED_DMG_UP = "restraintedDmgUp"
xyd.BUFF_RESTRAINT_DMG_UP = "restraintDmgUp"
xyd.BUFF_GROUP_DMG_UP = "groupDmgUp"
xyd.BUFF_CONTROL_DEC_HARM = "controlDecHarm"
xyd.BUFF_TARGET_DMG_UP = "targetDmgUp"
xyd.BUFF_DOT_NUM_HURT = "dotNumHurt"
xyd.BUFF_XIGEMA_POWER = "xigemaPower"
xyd.BUFF_GROUP6_HARM_DEC = "group6HarmDec"
xyd.BUFF_GROUP5_DMG_UP = "group5DmgUp"
xyd.BUFF_HP_SHIELD_RECOVER = "hpShieldRecover"
xyd.BUFF_DMG_RATE_SPREAD = "dmgRateSpread"
xyd.BUFF_DOT_MAX_HP = "dotMaxHp"
xyd.BUFF_QIANHEZI_HEAL = "qianheziHeal"
xyd.BUFF_QIANHEZI_DEC = "qianheziDec"
xyd.BUFF_XINGMANG = "xingmang"
xyd.BUFF_MINGZHONG_2_ALL_HARM = "mingzhong2AllHarm"
xyd.BUFF_YIFU_MARK = "yifuMark"
xyd.BUFF_HP_SHIELD_END_TO_HEAL = "hpShieldEndToHeal"
xyd.BUFF_QIUBITE_MARK = "qiubiteMark"
xyd.BUFF_QIUBITE_POWER = "qiubitePower"
xyd.BUFF_QIUBITE_HEAL = "qiubiteHeal"
xyd.BUFF_TARGET_HURT = "targetHurt"
xyd.BUFF_FREE_HARM_LEFT1 = "freeHarmLeft1"
xyd.BUFF_PLMXS_THORNS_HURT = "plmxsThornsHurt"
xyd.BUFF_HARM_TO_HEAL = "harmToHeal"
xyd.BUFF_HP_SHIELD_NO_RECORD_HARM = "hpShieldNoRecordHarm"
xyd.BUFF_LIANHUA_HITTED_HEAL = "lianhuaHittedHeal"
xyd.BUFF_LIANHUA_BLOOD_HURT = "lianhuaBloodHurt"
xyd.BUFF_HURT_FREE_SHIELD = "hurtFreeShield"
xyd.BUFF_AILISHE_COLOR1 = "ailisheColor1"
xyd.BUFF_AILISHE_COLOR2 = "ailisheColor2"
xyd.BUFF_AILISHE_COLOR3 = "ailisheColor3"
xyd.BUFF_AILISHE_COLOR12 = "ailisheColor12"
xyd.BUFF_AILISHE_COLOR13 = "ailisheColor13"
xyd.BUFF_AILISHE_COLOR23 = "ailisheColor23"
xyd.BUFF_AILISHE_COLOR123 = "ailisheColor123"
xyd.BUFF_AILISHE_ROUND3 = "ailisheRound3"
xyd.BUFF_HADISI_DEBUFF = "hadisiDebuff"
xyd.BUFF_NEXT_PUGONG_COLOR3 = "nextPugongColor3"
xyd.BUFF_HP_SHIELD_ANIM_FLAG = "hpShieldAnimFlag"
xyd.BUFF_HP_SHIELD_ANIM = "hpShieldAnim"
xyd.BUFF_AILISHE_COMBOL = "ailisheCombol"
xyd.BUFF_LONGNV_DEBUFF = "longnvDebuff"
xyd.BUFF_SHARE_BY_HURT = "shareByHurt"
xyd.BUFF_LONGNV_DEAD = "longnvDead"
xyd.BUFF_TO_CONTROL_DMG_UP = "toControlDmgUp"
xyd.BUFF_HITTED_HARDER = "hittedHarder"
xyd.BUFF_ANSUNA_TO_SHIELD = "ansunaToShield"
xyd.BUFF_ANSUNA_DOT = "ansunaDot"
xyd.BUFF_BLIND = "blind"
xyd.BUFF_SOUL_TEAR = "soulTear"
xyd.BUFF_SOUL_SEAL = "soulSeal"
xyd.BUFF_AIFEI_MARK = "aifeiMark"
xyd.BUFF_CRIT_TIME_LIMIT = "critTimeLimit"
xyd.BUFF_CRIT_ADD_HURT_MARK = "critAddHurtMark"
xyd.BUFF_TO_BOSS_ALL_DMG = "toBossAllDmg"
xyd.BUFF_HURT_3_ALL_DMG = "hurt3AllDmg"
xyd.BUFF_UP_HP_ALL_DMG = "upHpAllDmg"
xyd.BUFF_REAL_HURT_HP_LIMIT = "realHurtHpLimit"
xyd.BUFF_NINGSHI = "ningshi"
xyd.BUFF_SHUAIRUO = "shuairuo"
xyd.BUFF_HP_SHIELD_RATE = "hpShieldRate"
xyd.BUFF_CRIT_DEF_TO_DEC_DMG = "critDefToDecDmg"
xyd.BUFF_DEATH_LAYER = "deathLayer"
xyd.BUFF_DEATH_LAYER_MARK = "deathLayerMark"
xyd.BUFF_DEATH = "death"
xyd.BUFF_AIFEI_COUNT_SEAL = "aifeiCountSeal"
xyd.BUFF_BOSAIDONG_MARK = "bosaidongMark"
xyd.BUFF_ZHOUSI_TRUE_ATK = "zhousiTrueAtk"
xyd.BUFF_ZHOUSI_DOT = "zhousiDot"
xyd.BUFF_ZHOUSI_TRUE_ATK_EX = "zhousiTrueAtkEx"
...
function xyd.getRandom()
	...
	if xyd.Battle.has_random and xyd.Battle.has_random == 1 then
		...
		recordItem.num = xyd.Battle.randomSeed
		recordItem.round = xyd.Battle.round
		recordItem.from = {}
