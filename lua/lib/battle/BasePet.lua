-- chunkname: @../../../Product/Bundles/Android/src/lib/battle/BasePet.lua
...
function BasePet:getFighterModel(needCreate)
	...
	if needCreate and not self.fighterModel then
		...
		self.fighterModel:SetLocalScale(scaleX, math.abs(posChange[1]), 1)
...
function BasePet:playAnimation(name, callback, num)
	...
	model:SetLocalScale(scaleX, math.abs(posChange[1]), 1)
