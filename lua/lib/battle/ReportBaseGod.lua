-- chunkname: @../../../Product/Bundles/Android/src/lib/battle/ReportBaseGod.lua
...
function ReportBaseGod:addInitBuffs()
	...
	for _, skillID in ipairs(foreverSkills) do
		...
		for _, data in ipairs(datas) do
			...
			for k, v in ipairs(data.hitBuffs) do
				if v:getName() then
					table.insert(hitBuffs, v)
				end
			end
...
function ReportBaseGod:updateBuffCount(unit)
...
function ReportBaseGod:getGroup()
	return 0
end
