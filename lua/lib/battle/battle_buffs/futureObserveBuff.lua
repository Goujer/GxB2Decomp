-- chunkname: @../../../Product/Bundles/Android/src/lib/battle/battle_buffs/futureObserveBuff.lua
...
function futureObserveBuff:calculateFinalNum(name, num, buffData, forceHurt)
	local paramsBuffs = self.fighter:getBuffsByNameAndFighter(xyd.BUFF_FUTURE_OBSERVE_PARAMS)
...
local function _set_reg(fighter, defender, unit)
	...
	if defender:checkFreeHarm(unit) then
		return
	end
