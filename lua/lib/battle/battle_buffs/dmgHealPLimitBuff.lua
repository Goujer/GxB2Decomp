-- chunkname: @../../../Product/Bundles/Android/src/lib/battle/battle_buffs/dmgHealPLimitBuff.lua
...
function dmgHealPLimitBuff:setIsHit()
	...
	if self.isHit_ then
		...
		if self.target.dmgHealPLimitBuffTimes >= EffectTable:num(self.effectID, true)[2] then
			self.isHit_ = false
		end
	end
end
