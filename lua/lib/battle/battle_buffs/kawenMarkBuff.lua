-- chunkname: @../../../Product/Bundles/Android/src/lib/battle/battle_buffs/kawenMarkBuff.lua
...
function kawenMarkBuff:shareHarm(defender, finalNum, unit, attacker)
	...
	for k, v in ipairs(sharePartners) do
		...
		if v ~= defender then
			...
			v:addHpShield(unit, self.fighter:getAD() * self.finalNumArray_[4], self.skillID, v)
		end
	end
